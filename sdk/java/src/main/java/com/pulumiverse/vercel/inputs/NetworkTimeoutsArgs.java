...
public final class NetworkTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkTimeoutsArgs Empty = new NetworkTimeoutsArgs();
    ...
    private NetworkTimeoutsArgs() {}

    private NetworkTimeoutsArgs(NetworkTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(NetworkTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkTimeoutsArgs();
        }

        public Builder(NetworkTimeoutsArgs defaults) {
            $ = new NetworkTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkTimeoutsArgs build() {
            return $;
        }
    }
