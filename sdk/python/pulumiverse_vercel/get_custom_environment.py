...
def get_custom_environment(name: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The ID of the existing Vercel Project.
...
def get_custom_environment_output(name: Optional[pulumi.Input[builtins.str]] = None,
