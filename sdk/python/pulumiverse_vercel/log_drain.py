...
class LogDrainArgs:
    def __init__(__self__, *,
                 delivery_format: pulumi.Input[builtins.str],
                 endpoint: pulumi.Input[builtins.str],
                 environments: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[builtins.str] delivery_format: The format log data should be delivered in. Can be `json` or `ndjson`.
        :param pulumi.Input[builtins.str] endpoint: Logs will be sent as POST requests to this URL. The endpoint will be verified, and must return a `200` status code and an `x-vercel-verify` header taken from the endpoint_verification data source. The value the `x-vercel-verify` header should be can be read from the `vercel_endpoint_verification_code` data source.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] environments: Logs from the selected environments will be forwarded to your webhook. At least one must be present.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sources: A set of sources that the log drain should send logs for. Valid values are `static`, `edge`, `external`, `build` and `lambda`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: Custom headers to include in requests to the log drain endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_ids: A list of project IDs that the log drain should be associated with. Logs from these projects will be sent log events to the specified endpoint. If omitted, logs will be sent for all projects.
        :param pulumi.Input[builtins.float] sampling_rate: A ratio of logs matching the sampling rate will be sent to your log drain. Should be a value between 0 and 1. If unspecified, all logs are sent.
        :param pulumi.Input[builtins.str] secret: A custom secret to be used for signing log events. You can use this secret to verify that log events are coming from Vercel and are not tampered with. See https://vercel.com/docs/observability/log-drains/log-drains-reference#secure-log-drains for full info.
        :param pulumi.Input[builtins.str] team_id: The ID of the team the Log Drain should exist under. Required when configuring a team resource if a default team has not been set in the provider.
        """
    ...
    def delivery_format(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def delivery_format(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def environments(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @environments.setter
    def environments(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _LogDrainState:
    def __init__(__self__, *,
                 delivery_format: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="deliveryFormat")
    def delivery_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The format log data should be delivered in. Can be `json` or `ndjson`.
        """
        return pulumi.get(self, "delivery_format")
    ...
    @delivery_format.setter
    def delivery_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_format", value)
...
class LogDrain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret: Optional[pulumi.Input[builtins.str]] = None,
            sources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LogDrain':
        """
    ...
    @property
    @pulumi.getter(name="deliveryFormat")
    def delivery_format(self) -> pulumi.Output[builtins.str]:
        """
        The format log data should be delivered in. Can be `json` or `ndjson`.
        """
        return pulumi.get(self, "delivery_format")
    ...
    @property
    @pulumi.getter(name="projectIds")
    def project_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of project IDs that the log drain should be associated with. Logs from these projects will be sent log events to the specified endpoint. If omitted, logs will be sent for all projects.
        """
        return pulumi.get(self, "project_ids")
    ...
    @property
    @pulumi.getter(name="samplingRate")
    def sampling_rate(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        A ratio of logs matching the sampling rate will be sent to your log drain. Should be a value between 0 and 1. If unspecified, all logs are sent.
        """
        return pulumi.get(self, "sampling_rate")
