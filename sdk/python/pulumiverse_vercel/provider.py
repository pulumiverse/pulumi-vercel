...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_token: The Vercel API Token to use. This can also be specified with the `VERCEL_API_TOKEN` shell environment variable. Tokens
               can be created from your [Vercel settings](https://vercel.com/account/tokens).
        :param pulumi.Input[builtins.str] team: The default Vercel Team to use when creating resources or reading data sources. This can be provided as either a team
