...
class TeamMemberArgs:
    def __init__(__self__, *,
                 ...
                 access_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] role: The role that the user should have in the project. One of 'MEMBER', 'OWNER', 'VIEWER', 'DEVELOPER', 'BILLING' or 'CONTRIBUTOR'. Depending on your Team's plan, some of these roles may be unavailable.
        :param pulumi.Input[builtins.str] team_id: The ID of the existing Vercel Team.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] access_groups: If access groups are enabled on the team, and the user is a CONTRIBUTOR, `projects`, `access_groups` or both must be specified. A set of access groups IDs that the user should be granted access to.
        :param pulumi.Input[builtins.str] email: The email of the user to add to the team. Must specify one of user_id or email.
        ...
        :param pulumi.Input[builtins.str] user_id: The ID of the user to add to the team. Must specify one of user_id or email.
        """
    ...
    def access_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def access_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _TeamMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] access_groups: If access groups are enabled on the team, and the user is a CONTRIBUTOR, `projects`, `access_groups` or both must be specified. A set of access groups IDs that the user should be granted access to.
        :param pulumi.Input[builtins.bool] confirmed: Whether the user has confirmed their invitation.
        :param pulumi.Input[builtins.str] email: The email of the user to add to the team. Must specify one of user_id or email.
        :param pulumi.Input[Sequence[pulumi.Input['TeamMemberProjectArgs']]] projects: If access groups are enabled on the team, and the user is a CONTRIBUTOR, `projects`, `access_groups` or both must be specified. A set of projects that the user should be granted access to, along with their role in each project.
        :param pulumi.Input[builtins.str] role: The role that the user should have in the project. One of 'MEMBER', 'OWNER', 'VIEWER', 'DEVELOPER', 'BILLING' or 'CONTRIBUTOR'. Depending on your Team's plan, some of these roles may be unavailable.
        :param pulumi.Input[builtins.str] team_id: The ID of the existing Vercel Team.
...
class TeamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        by_user_id = vercel.TeamMember("byUserId",
            role="MEMBER",
            team_id="team_xxxxxxxxxxxxxxxxxxxxxxxx",
            user_id="uuuuuuuuuuuuuuuuuuuuuuuuuu")
        by_email = vercel.TeamMember("byEmail",
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TeamMember':
        """
    ...
    @property
    @pulumi.getter(name="accessGroups")
    def access_groups(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        If access groups are enabled on the team, and the user is a CONTRIBUTOR, `projects`, `access_groups` or both must be specified. A set of access groups IDs that the user should be granted access to.
        """
        return pulumi.get(self, "access_groups")
