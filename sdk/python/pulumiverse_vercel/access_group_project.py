...
class AccessGroupProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_group_id: The ID of the Access Group.
        :param pulumi.Input[builtins.str] project_id: The Project ID to assign to the access group.
        :param pulumi.Input[builtins.str] role: The project role to assign to the access group. Must be either `ADMIN`, `PROJECT_DEVELOPER`, or `PROJECT_VIEWER`.
        :param pulumi.Input[builtins.str] team_id: The ID of the team the access group project should exist under. Required when configuring a team resource if a default team has not been set in the provider.
        """
...
@pulumi.type_token("vercel:index/accessGroupProject:AccessGroupProject")
class AccessGroupProject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessGroupProject':
        """
