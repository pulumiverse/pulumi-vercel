...
__all__ = ['ProjectFunctionCpuArgs', 'ProjectFunctionCpu']

@pulumi.input_type
class ProjectFunctionCpuArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cpu: The amount of CPU available to your Serverless Functions. Should be one of 'basic' (0.6vCPU), 'standard' (1vCPU) or 'performance' (1.7vCPUs).
...
@pulumi.input_type
class _ProjectFunctionCpuState:
    def __init__(__self__, *,
...
class ProjectFunctionCpu(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        > This resource has been deprecated and no longer works. Please use the `Project` resource and its `resource_config` attribute instead.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ProjectFunctionCpuArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProjectFunctionCpuArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProjectFunctionCpuArgs.__new__(ProjectFunctionCpuArgs)
        ...
        super(ProjectFunctionCpu, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            cpu: Optional[pulumi.Input[str]] = None,
            project_id: Optional[pulumi.Input[str]] = None,
            team_id: Optional[pulumi.Input[str]] = None) -> 'ProjectFunctionCpu':
        """
        ...
        __props__ = _ProjectFunctionCpuState.__new__(_ProjectFunctionCpuState)

        __props__.__dict__["cpu"] = cpu
        __props__.__dict__["project_id"] = project_id
        __props__.__dict__["team_id"] = team_id
        return ProjectFunctionCpu(resource_name, opts=opts, __props__=__props__)
