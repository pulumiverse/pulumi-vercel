...
class DnsRecordArgs:
    def __init__(__self__, *,
                 ...
                 mx_priority: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] domain: The domain name, or zone, that the DNS record should be created beneath.
        :param pulumi.Input[builtins.str] type: The type of DNS record. Available types: `A`, `AAAA`, `ALIAS`, `CAA`, `CNAME`, `MX`, `NS`, `SRV`, `TXT`.
        :param pulumi.Input[builtins.str] comment: A comment explaining what the DNS record is for.
        :param pulumi.Input[builtins.int] mx_priority: The priority of the MX record. The priority specifies the sequence that an email server receives emails. A smaller value indicates a higher priority.
        :param pulumi.Input[builtins.str] name: The subdomain name of the record. This should be an empty string if the rercord is for the root domain.
        :param pulumi.Input['DnsRecordSrvArgs'] srv: Settings for an SRV record.
        :param pulumi.Input[builtins.str] team_id: The team ID that the domain and DNS records belong to. Required when configuring a team resource if a default team has not been set in the provider.
        :param pulumi.Input[builtins.int] ttl: The TTL value in seconds. Must be a number between 60 and 2147483647. If unspecified, it will default to 60 seconds.
        :param pulumi.Input[builtins.str] value: The value of the DNS record. The format depends on the 'type' property.
    ...
    def mx_priority(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @mx_priority.setter
    def mx_priority(self, value: Optional[pulumi.Input[builtins.int]]):
...
@pulumi.type_token("vercel:index/dnsRecord:DnsRecord")
class DnsRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'DnsRecord':
        """
    ...
    @property
    @pulumi.getter(name="mxPriority")
    def mx_priority(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The priority of the MX record. The priority specifies the sequence that an email server receives emails. A smaller value indicates a higher priority.
        """
        return pulumi.get(self, "mx_priority")
