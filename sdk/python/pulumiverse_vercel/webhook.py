...
class WebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint: Webhooks events will be sent as POST requests to this URL.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: A list of the events the webhook will listen to. At least one must be present.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_ids: A list of project IDs that the webhook should be associated with. These projects should send events to the specified endpoint.
        :param pulumi.Input[builtins.str] team_id: The ID of the team the Webhook should exist under. Required when configuring a team resource if a default team has not been set in the provider.
        """
...
class _WebhookState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: A list of the events the webhook will listen to. At least one must be present.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_ids: A list of project IDs that the webhook should be associated with. These projects should send events to the specified endpoint.
        :param pulumi.Input[builtins.str] secret: A secret value which will be provided in the `x-vercel-signature` header and can be used to verify the authenticity of the webhook. See https://vercel.com/docs/observability/webhooks-overview/webhooks-api#securing-webhooks for further details.
        :param pulumi.Input[builtins.str] team_id: The ID of the team the Webhook should exist under. Required when configuring a team resource if a default team has not been set in the provider.
        """
...
@pulumi.type_token("vercel:index/webhook:Webhook")
class Webhook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            secret: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Webhook':
        """
