...
def get_access_group(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The Access Group ID to be retrieved.
    :param builtins.str team_id: The ID of the team the Access Group should exist under. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_access_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
