...
def get_access_group(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The Access Group ID to be retrieved.
    :param _builtins.str team_id: The ID of the team the Access Group should exist under. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_access_group_output(id: Optional[pulumi.Input[_builtins.str]] = None,
                            team_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAccessGroupResult]:
    """
    Provides information about an existing Access Group.
