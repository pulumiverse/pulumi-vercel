...
class GetPrebuiltProjectResult:
    ...
    @property
    @pulumi.getter
    def output(self) -> Mapping[str, builtins.str]:
        """
...
def get_prebuilt_project(path: Optional[builtins.str] = None,
...
def get_prebuilt_project_output(path: Optional[pulumi.Input[builtins.str]] = None,
