...
class ProjectEnvironmentVariable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            targets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectEnvironmentVariable':
        """
    ...
    @property
    @pulumi.getter(name="customEnvironmentIds")
    def custom_environment_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The IDs of Custom Environments that the Environment Variable should be present on. At least one of `target` or `custom_environment_ids` must be set.
        """
        return pulumi.get(self, "custom_environment_ids")
    ...
    @property
    @pulumi.getter
    def sensitive(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the Environment Variable is sensitive or not. (May be affected by a [team-wide environment variable policy](https://vercel.com/docs/projects/environment-variables/sensitive-environment-variables#environment-variables-policy))
        """
        return pulumi.get(self, "sensitive")
