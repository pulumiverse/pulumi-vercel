...
class EdgeConfigTokenArgs:
    def __init__(__self__, *,
                 edge_config_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] edge_config_id: The ID of the Edge Config store.
        :param pulumi.Input[builtins.str] label: The label of the Edge Config Token.
        :param pulumi.Input[builtins.str] team_id: The ID of the team the Edge Config should exist under. Required when configuring a team resource if a default team has not been set in the provider.
        """
    ...
    def edge_config_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def edge_config_id(self, value: pulumi.Input[builtins.str]):
...
class _EdgeConfigTokenState:
    def __init__(__self__, *,
                 ...
                 edge_config_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connection_string: A connection string is a URL that connects a project to an Edge Config. The variable can be called anything, but our Edge Config client SDK will search for process.env.EDGE_CONFIG by default.
        :param pulumi.Input[builtins.str] edge_config_id: The ID of the Edge Config store.
        :param pulumi.Input[builtins.str] label: The label of the Edge Config Token.
        :param pulumi.Input[builtins.str] team_id: The ID of the team the Edge Config should exist under. Required when configuring a team resource if a default team has not been set in the provider.
        :param pulumi.Input[builtins.str] token: A read access token used for authenticating against the Edge Config's endpoint for high volume, low-latency requests.
        """
    ...
    @property
    @pulumi.getter(name="edgeConfigId")
    def edge_config_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Edge Config store.
        """
        return pulumi.get(self, "edge_config_id")
    ...
    @edge_config_id.setter
    def edge_config_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "edge_config_id", value)
...
@pulumi.type_token("vercel:index/edgeConfigToken:EdgeConfigToken")
class EdgeConfigToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            label: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None) -> 'EdgeConfigToken':
        """
    ...
    @property
    @pulumi.getter(name="edgeConfigId")
    def edge_config_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Edge Config store.
        """
        return pulumi.get(self, "edge_config_id")
