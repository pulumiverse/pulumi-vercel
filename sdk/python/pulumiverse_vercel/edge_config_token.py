...
class _EdgeConfigTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] label: The label of the Edge Config Token.
        :param pulumi.Input[_builtins.str] team_id: The ID of the team the Edge Config should exist under. Required when configuring a team resource if a default team has not been set in the provider.
        :param pulumi.Input[_builtins.str] token: A read access token used for authenticating against the Edge Config's endpoint for high volume, low-latency requests.
        """
...
class EdgeConfigToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            label: Optional[pulumi.Input[_builtins.str]] = None,
            team_id: Optional[pulumi.Input[_builtins.str]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None) -> 'EdgeConfigToken':
        """
