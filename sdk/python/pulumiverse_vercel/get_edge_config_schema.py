...
def get_edge_config_schema(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The ID of the Edge Config that the schema should be for.
...
def get_edge_config_schema_output(id: Optional[pulumi.Input[_builtins.str]] = None,
                                  team_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEdgeConfigSchemaResult]:
    """
    An Edge Config Schema provides an existing Edge Config with a JSON schema. Use schema protection to prevent unexpected updates that may cause bugs or downtime.
