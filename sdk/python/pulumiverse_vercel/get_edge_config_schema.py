...
def get_edge_config_schema(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the Edge Config that the schema should be for.
...
def get_edge_config_schema_output(id: Optional[pulumi.Input[builtins.str]] = None,
