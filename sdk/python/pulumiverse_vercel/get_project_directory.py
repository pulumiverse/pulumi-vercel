...
class GetProjectDirectoryResult:
    ...
    @property
    @pulumi.getter
    def files(self) -> Mapping[str, builtins.str]:
        """
...
def get_project_directory(path: Optional[builtins.str] = None,
...
def get_project_directory_output(path: Optional[pulumi.Input[builtins.str]] = None,
