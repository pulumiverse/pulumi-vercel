...
def get_edge_config_item(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the Edge Config that the item should exist under.
    :param builtins.str key: The name of the key you want to retrieve within your Edge Config.
...
def get_edge_config_item_output(id: Optional[pulumi.Input[builtins.str]] = None,
