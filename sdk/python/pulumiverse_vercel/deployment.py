...
class DeploymentArgs:
    def __init__(__self__, *,
                 ...
                 delete_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 production: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] project_id: The project ID to add the deployment to.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment: A map of environment variable names to values. These are specific to a Deployment, and can also be configured on the `Project` resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] files: A map of files to be uploaded for the deployment. This should be provided by a `get_project_directory` or `get_file` data source. Required if `git_source` is not set.
        :param pulumi.Input[builtins.str] path_prefix: If specified then the `path_prefix` will be stripped from the start of file paths as they are uploaded to Vercel. If this is omitted, then any leading `../`s will be stripped.
        :param pulumi.Input[builtins.bool] production: true if the deployment is a production deployment, meaning production aliases will be assigned.
        ...
        :param pulumi.Input[builtins.str] ref: The branch or commit hash that should be deployed. Note this will only work if the project is configured to use a Git repository. Required if `files` is not set.
        :param pulumi.Input[builtins.str] team_id: The team ID to add the deployment to. Required when configuring a team resource if a default team has not been set in the provider.
        """
    ...
    def delete_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "delete_on_destroy")

    @delete_on_destroy.setter
    def delete_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def production(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @production.setter
    def production(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DeploymentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: A list of all the domains (default domains, staging domains and production domains) that were assigned upon deployment creation.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment: A map of environment variable names to values. These are specific to a Deployment, and can also be configured on the `Project` resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] files: A map of files to be uploaded for the deployment. This should be provided by a `get_project_directory` or `get_file` data source. Required if `git_source` is not set.
        :param pulumi.Input[builtins.str] path_prefix: If specified then the `path_prefix` will be stripped from the start of file paths as they are uploaded to Vercel. If this is omitted, then any leading `../`s will be stripped.
        :param pulumi.Input[builtins.bool] production: true if the deployment is a production deployment, meaning production aliases will be assigned.
        ...
        :param pulumi.Input[builtins.str] ref: The branch or commit hash that should be deployed. Note this will only work if the project is configured to use a Git repository. Required if `files` is not set.
        :param pulumi.Input[builtins.str] team_id: The team ID to add the deployment to. Required when configuring a team resource if a default team has not been set in the provider.
        :param pulumi.Input[builtins.str] url: A unique URL that is automatically generated for a deployment.
        """
        if delete_on_destroy is not None:
            pulumi.set(__self__, "delete_on_destroy", delete_on_destroy)
...
@pulumi.type_token("vercel:index/deployment:Deployment")
class Deployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ref: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'Deployment':
        """
    ...
    @property
    @pulumi.getter(name="deleteOnDestroy")
    def delete_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "delete_on_destroy")
    ...
    @property
    @pulumi.getter
    def production(self) -> pulumi.Output[builtins.bool]:
        """
        true if the deployment is a production deployment, meaning production aliases will be assigned.
        """
        return pulumi.get(self, "production")
