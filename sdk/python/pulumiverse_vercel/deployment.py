...
class DeploymentArgs:
    def __init__(__self__, *,
                 ...
                 files: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] path_prefix: If specified then the `path_prefix` will be stripped from the start of file paths as they are uploaded to Vercel. If this is omitted, then any leading `../`s will be stripped.
        :param pulumi.Input[_builtins.bool] production: true if the deployment is a production deployment, meaning production aliases will be assigned.
        ...
        :param pulumi.Input[_builtins.str] ref: The branch or commit hash that should be deployed. Note this will only work if the project is configured to use a Git repository. Required if `files` is not set.
        :param pulumi.Input[_builtins.str] team_id: The team ID to add the deployment to. Required when configuring a team resource if a default team has not been set in the provider.
        """
    ...
    @files.setter
    def files(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class _DeploymentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ref: The branch or commit hash that should be deployed. Note this will only work if the project is configured to use a Git repository. Required if `files` is not set.
        :param pulumi.Input[_builtins.str] team_id: The team ID to add the deployment to. Required when configuring a team resource if a default team has not been set in the provider.
        :param pulumi.Input[_builtins.str] url: A unique URL that is automatically generated for a deployment.
        """
        if custom_environment_id is not None:
            pulumi.set(__self__, "custom_environment_id", custom_environment_id)
        if delete_on_destroy is not None:
...
class Deployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ref: Optional[pulumi.Input[_builtins.str]] = None,
            team_id: Optional[pulumi.Input[_builtins.str]] = None,
            url: Optional[pulumi.Input[_builtins.str]] = None) -> 'Deployment':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def meta(self) -> pulumi.Output[Mapping[str, _builtins.str]]:
        """
        Arbitrary key/value metadata to attach to the deployment (equivalent to the Vercel CLI --meta flags).
        """
        return pulumi.get(self, "meta")
    ...
    @_builtins.property
    @pulumi.getter
    def production(self) -> pulumi.Output[_builtins.bool]:
        """
        true if the deployment is a production deployment, meaning production aliases will be assigned.
        """
        return pulumi.get(self, "production")
