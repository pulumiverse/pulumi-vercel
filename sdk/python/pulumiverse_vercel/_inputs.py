...
__all__ = [
    ...
    'AlertRuleNotificationSettingsArgsDict',
    'AlertRuleRuleScopeArgs',
    'AlertRuleRuleScopeArgsDict',
    ...
    'ProjectDeploymentCheckSourceArgsDict',
...
class AlertRuleNotificationSettingsArgsDict(TypedDict):
    enable_team_owner_notifications: NotRequired[pulumi.Input[_builtins.bool]]
    incident_io_routing_key: NotRequired[pulumi.Input[_builtins.str]]

@pulumi.input_type
class AlertRuleNotificationSettingsArgs:
    def __init__(__self__, *,
                 enable_team_owner_notifications: Optional[pulumi.Input[_builtins.bool]] = None,
                 incident_io_routing_key: Optional[pulumi.Input[_builtins.str]] = None):
    ...
    def enable_team_owner_notifications(self) -> Optional[pulumi.Input[_builtins.bool]]:
        return pulumi.get(self, "enable_team_owner_notifications")

    @enable_team_owner_notifications.setter
    def enable_team_owner_notifications(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "enable_team_owner_notifications", value)

    @_builtins.property
    @pulumi.getter(name="incidentIoRoutingKey")
    def incident_io_routing_key(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "incident_io_routing_key")

    @incident_io_routing_key.setter
    def incident_io_routing_key(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "incident_io_routing_key", value)


class AlertRuleRuleScopeArgsDict(TypedDict):
...
@pulumi.input_type
class AlertRuleRuleScopeArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[_builtins.str],
                 project_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] project_ids: The project IDs included in or excluded from a built-in rule.
        """
...
class AlertRuleTriggerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] type: The built-in anomaly trigger type.
        :param pulumi.Input[_builtins.str] filter: A KQL filter for `error_anomaly` or `usage_anomaly`. See the trigger filter documentation above for supported fields and values.
        """
        pulumi.set(__self__, "type", type)
...
class ProjectDeploymentCheckSourceArgsDict(TypedDict):
    kind: pulumi.Input[_builtins.str]
    """
    The source kind. New checks support `git-provider`, `integration`, and `webhook`; `vercel` is response-only.
    """
    external_check_name: NotRequired[pulumi.Input[_builtins.str]]
    """
    The external check name. Required for a `git-provider` source.
    """
    external_resource_id: NotRequired[pulumi.Input[_builtins.str]]
    """
...
@pulumi.input_type
class ProjectDeploymentCheckSourceArgs:
    def __init__(__self__, *,
                 kind: pulumi.Input[_builtins.str],
                 external_check_name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        """
        :param pulumi.Input[_builtins.str] kind: The source kind. New checks support `git-provider`, `integration`, and `webhook`; `vercel` is response-only.
        :param pulumi.Input[_builtins.str] external_check_name: The external check name. Required for a `git-provider` source.
        :param pulumi.Input[_builtins.str] external_resource_id: An optional external resource ID for an `integration` source. Creating integration checks requires an integration token; the API derives integration IDs from that token.
        :param pulumi.Input[_builtins.str] provider: The Git provider. New git-provider checks currently support `github`; imported checks may report `gitlab` or `bitbucket`.
        :param pulumi.Input[_builtins.str] webhook_id: The webhook ID for a `webhook` source.
        """
    ...
    def external_check_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The external check name. Required for a `git-provider` source.
        """
        return pulumi.get(self, "external_check_name")

    @external_check_name.setter
    def external_check_name(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "external_check_name", value)
