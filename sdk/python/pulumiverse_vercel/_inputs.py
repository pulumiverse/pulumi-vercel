...
class CustomEnvironmentBranchTrackingArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] pattern: The pattern of the branch name to track.
        :param pulumi.Input[builtins.str] type: How a branch name should be matched against the pattern. Must be one of 'startsWith', 'endsWith' or 'equals'.
        """
...
class DeploymentProjectSettingsArgs:
    def __init__(__self__, *,
                 ...
                 install_command: Optional[pulumi.Input[builtins.str]] = None,
                 output_directory: Optional[pulumi.Input[builtins.str]] = None,
                 root_directory: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] build_command: The build command for this deployment. If omitted, this value will be taken from the project or automatically detected.
        :param pulumi.Input[builtins.str] framework: The framework that is being used for this deployment. If omitted, no framework is selected.
        :param pulumi.Input[builtins.str] install_command: The install command for this deployment. If omitted, this value will be taken from the project or automatically detected.
        :param pulumi.Input[builtins.str] output_directory: The output directory of the deployment. If omitted, this value will be taken from the project or automatically detected.
        :param pulumi.Input[builtins.str] root_directory: The name of a directory or relative path to the source code of your project. When null is used it will default to the project root.
        """
    ...
    def install_command(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The install command for this deployment. If omitted, this value will be taken from the project or automatically detected.
        """
    ...
    def install_command(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "install_command", value)

    @property
    @pulumi.getter(name="outputDirectory")
    def output_directory(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The output directory of the deployment. If omitted, this value will be taken from the project or automatically detected.
        """
    ...
    def output_directory(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DnsRecordSrvArgs:
    def __init__(__self__, *,
                 ...
                 weight: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] port: The TCP or UDP port on which the service is to be found.
        :param pulumi.Input[builtins.int] priority: The priority of the target host, lower value means more preferred.
        :param pulumi.Input[builtins.str] target: The canonical hostname of the machine providing the service, ending in a dot.
        :param pulumi.Input[builtins.int] weight: A relative weight for records with the same priority, higher value means higher chance of getting picked.
        """
...
class FirewallConfigIpRulesRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] hostname: Hosts to apply these rules to
        :param pulumi.Input[builtins.str] ip: IP or CIDR to block
        """
...
class FirewallConfigRulesRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name to identify the rule
        :param pulumi.Input[builtins.bool] active: Rule is active or disabled
        """
        pulumi.set(__self__, "action", action)
...
if not MYPY:
    class FirewallConfigRulesRuleActionArgsDict(TypedDict):
        ...
        Base action
        """
        action_duration: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FirewallConfigRulesRuleActionArgs:
    def __init__(__self__, *,
                 action: pulumi.Input[builtins.str],
                 action_duration: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] action: Base action
        :param pulumi.Input[builtins.str] action_duration: Forward persistence of a rule action
    ...
    def action_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Forward persistence of a rule action
        """
    ...
    def action_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FirewallConfigRulesRuleActionRateLimitArgsDict(TypedDict):
        ...
        """
        limit: pulumi.Input[builtins.int]
        """
...
class FirewallConfigRulesRuleActionRateLimitArgs:
    def __init__(__self__, *,
                 ...
                 window: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] action: Action to take when rate limit is exceeded
        :param pulumi.Input[builtins.str] algo: Rate limiting algorithm
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] keys: Keys used to bucket an individual client
        :param pulumi.Input[builtins.int] limit: number of requests allowed in the window
        :param pulumi.Input[builtins.int] window: Time window in seconds
        """
        pulumi.set(__self__, "action", action)
    ...
    @property
    @pulumi.getter
    def limit(self) -> pulumi.Input[builtins.int]:
        """
        number of requests allowed in the window
        """
    ...
    @limit.setter
    def limit(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class FirewallConfigRulesRuleConditionGroupConditionArgsDict(TypedDict):
        ...
        """
        neg: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class FirewallConfigRulesRuleConditionGroupConditionArgs:
    def __init__(__self__, *,
                 ...
                 neg: Optional[pulumi.Input[builtins.bool]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None,
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] op: How to comparse type to value
        :param pulumi.Input[builtins.str] type: Request key type to match against
        :param pulumi.Input[builtins.str] key: Key within type to match against
        :param pulumi.Input[builtins.bool] neg: Negate the condition
        :param pulumi.Input[builtins.str] value: Value to match against
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Values to match against if op is inc, ninc
        """
    ...
    @property
    @pulumi.getter
    def neg(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Negate the condition
        """
    ...
    @neg.setter
    def neg(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class MicrofrontendGroupDefaultAppArgsDict(TypedDict):
        ...
        """
        default_route: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MicrofrontendGroupDefaultAppArgs:
    def __init__(__self__, *,
                 project_id: pulumi.Input[builtins.str],
                 default_route: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] project_id: The ID of the project.
        :param pulumi.Input[builtins.str] default_route: The default route for the project. Used for the screenshot of deployments.
        """
    ...
    def default_route(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The default route for the project. Used for the screenshot of deployments.
        """
    ...
    def default_route(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ProjectEnvironmentArgsDict(TypedDict):
        ...
        """
        custom_environment_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        git_branch: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        sensitive: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ProjectEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 custom_environment_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 git_branch: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 sensitive: Optional[pulumi.Input[builtins.bool]] = None,
                 targets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] key: The name of the Environment Variable.
        :param pulumi.Input[builtins.str] value: The value of the Environment Variable.
        :param pulumi.Input[builtins.str] comment: A comment explaining what the environment variable is for.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_environment_ids: The IDs of Custom Environments that the Environment Variable should be present on. At least one of `target` or `custom_environment_ids` must be set.
        :param pulumi.Input[builtins.str] git_branch: The git branch of the Environment Variable.
        :param pulumi.Input[builtins.str] id: The ID of the Environment Variable.
        :param pulumi.Input[builtins.bool] sensitive: Whether the Environment Variable is sensitive or not. (May be affected by a [team-wide environment variable policy](https://vercel.com/docs/projects/environment-variables/sensitive-environment-variables#environment-variables-policy))
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: The environments that the Environment Variable should be present on. Valid targets are either `production`, `preview`, or `development`. At least one of `target` or `custom_environment_ids` must be set.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
    ...
    def custom_environment_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The IDs of Custom Environments that the Environment Variable should be present on. At least one of `target` or `custom_environment_ids` must be set.
        """
    ...
    def custom_environment_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter
    def sensitive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the Environment Variable is sensitive or not. (May be affected by a [team-wide environment variable policy](https://vercel.com/docs/projects/environment-variables/sensitive-environment-variables#environment-variables-policy))
        """
    ...
    @sensitive.setter
    def sensitive(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ProjectEnvironmentVariablesVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] git_branch: The git branch of the Environment Variable.
        :param pulumi.Input[builtins.str] id: The ID of the Environment Variable.
        :param pulumi.Input[builtins.bool] sensitive: Whether the Environment Variable is sensitive or not.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: The environments that the Environment Variable should be present on. Valid targets are either `production`, `preview`, or `development`. At least one of `target` or `custom_environment_ids` must be set.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class ProjectGitCommentsArgsDict(TypedDict):
        on_commit: pulumi.Input[builtins.bool]
        """
        Whether Commit comments are enabled
        """
        on_pull_request: pulumi.Input[builtins.bool]
        """
...
class ProjectGitCommentsArgs:
    def __init__(__self__, *,
                 ...
                 on_pull_request: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] on_commit: Whether Commit comments are enabled
        :param pulumi.Input[builtins.bool] on_pull_request: Whether Pull Request comments are enabled
        """
    ...
    def on_commit(self) -> pulumi.Input[builtins.bool]:
        """
        Whether Commit comments are enabled
        """
    ...
    @on_commit.setter
    def on_commit(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "on_commit", value)

    @property
    @pulumi.getter(name="onPullRequest")
    def on_pull_request(self) -> pulumi.Input[builtins.bool]:
        """
        Whether Pull Request comments are enabled
        """
    ...
    def on_pull_request(self, value: pulumi.Input[builtins.bool]):
...
class ProjectGitRepositoryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] repo: The name of the git repository. For example: `vercel/next.js`.
        :param pulumi.Input[builtins.str] type: The git provider of the repository. Must be either `github`, `gitlab`, or `bitbucket`.
        ...
        :param pulumi.Input[builtins.str] production_branch: By default, every commit pushed to the main branch will trigger a Production Deployment instead of the usual Preview Deployment. You can switch to a different branch here.
        """
...
class ProjectGitRepositoryDeployHookArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the deploy hook.
        :param pulumi.Input[builtins.str] ref: The branch or commit hash that should be deployed.
        :param pulumi.Input[builtins.str] id: The ID of the deploy hook.
        :param pulumi.Input[builtins.str] url: A URL that, when a POST request is made to, will trigger a new deployment.
        """
        pulumi.set(__self__, "name", name)
...
class ProjectMembersMemberArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] role: The role that the user should have in the project. One of 'MEMBER', 'PROJECT*DEVELOPER', or 'PROJECT*VIEWER'.
        :param pulumi.Input[builtins.str] email: The email of the user to add to the project. Exactly one of `user_id`, `email`, or `username` must be specified.
        :param pulumi.Input[builtins.str] user_id: The ID of the user to add to the project. Exactly one of `user_id`, `email`, or `username` must be specified.
        :param pulumi.Input[builtins.str] username: The username of the user to add to the project. Exactly one of `user_id`, `email`, or `username` must be specified.
        """
...
if not MYPY:
    class ProjectOidcTokenConfigArgsDict(TypedDict):
        ...
        """
        issuer_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProjectOidcTokenConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: When true, Vercel issued OpenID Connect (OIDC) tokens will be available on the compute environments. See https://vercel.com/docs/security/secure-backend-access/oidc for more information.
        :param pulumi.Input[builtins.str] issuer_mode: Configures the URL of the `iss` claim. `team` = `https://oidc.vercel.com/[team_slug]` `global` = `https://oidc.vercel.com`
        """
    ...
    def issuer_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Configures the URL of the `iss` claim. `team` = `https://oidc.vercel.com/[team_slug]` `global` = `https://oidc.vercel.com`
        """
    ...
    @issuer_mode.setter
    def issuer_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ProjectOptionsAllowlistPathArgs:
    def __init__(__self__, *,
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] value: The path prefix to compare with the incoming request path.
        """
        pulumi.set(__self__, "value", value)
...
class ProjectPasswordProtectionArgs:
    def __init__(__self__, *,
                 ...
                 password: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] deployment_type: The deployment environment to protect. Must be one of `standard_protection`, `all_deployments`, or `only_preview_deployments`.
        :param pulumi.Input[builtins.str] password: The password that visitors must enter to gain access to your Preview Deployments. Drift detection is not possible for this field.
        """
...
if not MYPY:
    class ProjectResourceConfigArgsDict(TypedDict):
        fluid: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        function_default_cpu_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        function_default_timeout: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ProjectResourceConfigArgs:
    def __init__(__self__, *,
                 fluid: Optional[pulumi.Input[builtins.bool]] = None,
                 function_default_cpu_type: Optional[pulumi.Input[builtins.str]] = None,
                 function_default_timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] fluid: Enable fluid compute for your Vercel Functions to automatically manage concurrency and optimize performance. Vercel will handle the defaults to ensure the best experience for your workload.
        :param pulumi.Input[builtins.str] function_default_cpu_type: The amount of CPU available to your Serverless Functions. Should be one of 'standard_legacy' (0.6vCPU), 'standard' (1vCPU) or 'performance' (1.7vCPUs).
        :param pulumi.Input[builtins.int] function_default_timeout: The default timeout for Serverless Functions.
        """
    ...
    @property
    @pulumi.getter
    def fluid(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable fluid compute for your Vercel Functions to automatically manage concurrency and optimize performance. Vercel will handle the defaults to ensure the best experience for your workload.
        """
    ...
    @fluid.setter
    def fluid(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "fluid", value)

    @property
    @pulumi.getter(name="functionDefaultCpuType")
    def function_default_cpu_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The amount of CPU available to your Serverless Functions. Should be one of 'standard_legacy' (0.6vCPU), 'standard' (1vCPU) or 'performance' (1.7vCPUs).
        """
    ...
    def function_default_cpu_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "function_default_cpu_type", value)

    @property
    @pulumi.getter(name="functionDefaultTimeout")
    def function_default_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The default timeout for Serverless Functions.
        """
    ...
    def function_default_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ProjectTrustedIpsArgsDict(TypedDict):
        ...
        """
        protection_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProjectTrustedIpsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] deployment_type: The deployment environment to protect. Must be one of `standard_protection`, `all_deployments`, `only_production_deployments`, or `only_preview_deployments`.
        :param pulumi.Input[builtins.str] protection_mode: Whether or not Trusted IPs is optional to access a deployment. Must be either `trusted_ip_required` or `trusted_ip_optional`. `trusted_ip_optional` is only available with Standalone Trusted IPs.
        """
...
class ProjectTrustedIpsAddressArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] value: The address or CIDR range that can access deployments.
        :param pulumi.Input[builtins.str] note: A description for the value
        """
        pulumi.set(__self__, "value", value)
        if note is not None:
...
class ProjectVercelAuthenticationArgs:
    def __init__(__self__, *,
                 deployment_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] deployment_type: The deployment environment to protect. Must be one of `standard_protection`, `all_deployments`, `only_preview_deployments`, or `none`.
        """
        pulumi.set(__self__, "deployment_type", deployment_type)
...
class TeamConfigRemoteCachingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates if Remote Caching is enabled.
        """
...
class TeamConfigSamlArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enforced: Indicates if SAML is enforced for the team.
...
if not MYPY:
    class TeamConfigSamlRolesArgsDict(TypedDict):
        access_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TeamConfigSamlRolesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] access_group_id: The access group id to assign to the user.
        :param pulumi.Input[builtins.str] role: The team level role to assign to the user. One of 'MEMBER', 'OWNER', 'VIEWER', 'DEVELOPER', 'BILLING' or 'CONTRIBUTOR'.
        """
...
class TeamMemberProjectArgs:
    def __init__(__self__, *,
                 ...
                 role: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] project_id: The ID of the project that the user should be granted access to.
        :param pulumi.Input[builtins.str] role: The role that the user should have in the project.
        """
        pulumi.set(__self__, "project_id", project_id)
        pulumi.set(__self__, "role", role)
