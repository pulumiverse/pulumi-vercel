...
class SharedEnvironmentVariableProjectLinkArgs:
    def __init__(__self__, *,
                 ...
                 shared_environment_variable_id: pulumi.Input[_builtins.str],
    ...
    def shared_environment_variable_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def shared_environment_variable_id(self, value: pulumi.Input[_builtins.str]):
...
class _SharedEnvironmentVariableProjectLinkState:
    def __init__(__self__, *,
                 ...
                 shared_environment_variable_id: Optional[pulumi.Input[_builtins.str]] = None,
                 team_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sharedEnvironmentVariableId")
    def shared_environment_variable_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The ID of the shared environment variable.
        """
        return pulumi.get(self, "shared_environment_variable_id")
    ...
    @shared_environment_variable_id.setter
    def shared_environment_variable_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "shared_environment_variable_id", value)
...
class SharedEnvironmentVariableProjectLink(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            shared_environment_variable_id: Optional[pulumi.Input[_builtins.str]] = None,
            team_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SharedEnvironmentVariableProjectLink':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sharedEnvironmentVariableId")
    def shared_environment_variable_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the shared environment variable.
        """
        return pulumi.get(self, "shared_environment_variable_id")
