...
class SharedEnvironmentVariableProjectLinkArgs:
    def __init__(__self__, *,
                 ...
                 shared_environment_variable_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] shared_environment_variable_id: The ID of the shared environment variable.
    ...
    def shared_environment_variable_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def shared_environment_variable_id(self, value: pulumi.Input[builtins.str]):
...
class _SharedEnvironmentVariableProjectLinkState:
    def __init__(__self__, *,
                 ...
                 shared_environment_variable_id: Optional[pulumi.Input[builtins.str]] = None,
                 team_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="sharedEnvironmentVariableId")
    def shared_environment_variable_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the shared environment variable.
        """
        return pulumi.get(self, "shared_environment_variable_id")
    ...
    @shared_environment_variable_id.setter
    def shared_environment_variable_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "shared_environment_variable_id", value)
...
@pulumi.type_token("vercel:index/sharedEnvironmentVariableProjectLink:SharedEnvironmentVariableProjectLink")
class SharedEnvironmentVariableProjectLink(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_shared_environment_variable = vercel.get_shared_environment_variable(key="EXAMPLE_ENV_VAR",
            targets=[
                "production",
                "preview",
            ])
        example_project = vercel.Project("exampleProject")
        example_shared_environment_variable_project_link = vercel.SharedEnvironmentVariableProjectLink("exampleSharedEnvironmentVariableProjectLink",
            shared_environment_variable_id=example_shared_environment_variable.id,
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            shared_environment_variable_id: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SharedEnvironmentVariableProjectLink':
        """
    ...
    @property
    @pulumi.getter(name="sharedEnvironmentVariableId")
    def shared_environment_variable_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the shared environment variable.
        """
        return pulumi.get(self, "shared_environment_variable_id")
