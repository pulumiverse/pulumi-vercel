...
class EdgeConfigSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] definition: A JSON schema that will be used to validate data in the Edge Config.
...
class EdgeConfigSchema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            definition: Optional[pulumi.Input[_builtins.str]] = None,
            team_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'EdgeConfigSchema':
        """
