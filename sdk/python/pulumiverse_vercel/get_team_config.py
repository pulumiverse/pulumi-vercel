...
class GetTeamConfigResult:
    ...
    def email_domain(self) -> builtins.str:
        """
    ...
    def enable_preview_feedback(self) -> builtins.str:
        """
    ...
    def enable_production_feedback(self) -> builtins.str:
        """
    ...
    def hide_ip_addresses(self) -> builtins.bool:
        """
    ...
    def hide_ip_addresses_in_log_drains(self) -> builtins.bool:
        """
    ...
    def invite_code(self) -> builtins.str:
        """
    ...
    def preview_deployment_suffix(self) -> builtins.str:
        """
    ...
    def sensitive_environment_variable_policy(self) -> builtins.str:
        """
...
def get_team_config(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the existing Vercel Team.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_team_config_output(id: Optional[pulumi.Input[builtins.str]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTeamConfigResult]:
    """
    Retrieves the configuration of an existing Vercel Team.
