...
def get_edge_config_token(edge_config_id: Optional[builtins.str] = None,
    ...
    :param builtins.str edge_config_id: The label of the Edge Config Token.
    ...
    :param builtins.str token: A read access token used for authenticating against the Edge Config's endpoint for high volume, low-latency requests.
    """
    __args__ = dict()
...
def get_edge_config_token_output(edge_config_id: Optional[pulumi.Input[builtins.str]] = None,
