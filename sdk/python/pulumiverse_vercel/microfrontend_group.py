...
class MicrofrontendGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: A human readable name for the microfrontends group.
...
class _MicrofrontendGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MicrofrontendGroupDefaultAppArgs'] default_app: The default app for the project. Used as the entry point for the microfrontend.
        :param pulumi.Input[builtins.str] name: A human readable name for the microfrontends group.
        :param pulumi.Input[builtins.str] slug: A slugified version of the name.
        :param pulumi.Input[builtins.str] team_id: The team ID to add the microfrontend group to. Required when configuring a team resource if a default team has not been set in the provider.
        """
...
@pulumi.type_token("vercel:index/microfrontendGroup:MicrofrontendGroup")
class MicrofrontendGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            slug: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MicrofrontendGroup':
        """
