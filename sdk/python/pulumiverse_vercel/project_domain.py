...
class ProjectDomainArgs:
    def __init__(__self__, *,
                 ...
                 custom_environment_id: Optional[pulumi.Input[builtins.str]] = None,
                 git_branch: Optional[pulumi.Input[builtins.str]] = None,
                 redirect: Optional[pulumi.Input[builtins.str]] = None,
                 redirect_status_code: Optional[pulumi.Input[builtins.int]] = None,
                 team_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ProjectDomain resource.
        :param pulumi.Input[builtins.str] domain: The domain name to associate with the project.
        :param pulumi.Input[builtins.str] project_id: The project ID to add the deployment to.
        :param pulumi.Input[builtins.str] custom_environment_id: The name of the Custom Environment to link to the Project Domain. Deployments from this custom environment will be assigned the domain name.
        :param pulumi.Input[builtins.str] git_branch: Git branch to link to the project domain. Deployments from this git branch will be assigned the domain name.
        :param pulumi.Input[builtins.str] redirect: The domain name that serves as a target destination for redirects.
        :param pulumi.Input[builtins.int] redirect_status_code: The HTTP status code to use when serving as a redirect.
        :param pulumi.Input[builtins.str] team_id: The ID of the team the project exists under. Required when configuring a team resource if a default team has not been set in the provider.
        """
    ...
    def custom_environment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_environment_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def redirect(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @redirect.setter
    def redirect(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "redirect", value)

    @property
    @pulumi.getter(name="redirectStatusCode")
    def redirect_status_code(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def redirect_status_code(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ProjectDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            redirect: Optional[pulumi.Input[builtins.str]] = None,
            redirect_status_code: Optional[pulumi.Input[builtins.int]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectDomain':
        """
    ...
    @property
    @pulumi.getter(name="customEnvironmentId")
    def custom_environment_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Custom Environment to link to the Project Domain. Deployments from this custom environment will be assigned the domain name.
        """
        return pulumi.get(self, "custom_environment_id")
    ...
    @property
    @pulumi.getter
    def redirect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The domain name that serves as a target destination for redirects.
        """
        return pulumi.get(self, "redirect")
    ...
    @property
    @pulumi.getter(name="redirectStatusCode")
    def redirect_status_code(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The HTTP status code to use when serving as a redirect.
        """
        return pulumi.get(self, "redirect_status_code")
