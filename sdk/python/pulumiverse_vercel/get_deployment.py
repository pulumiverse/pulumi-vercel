...
class GetDeploymentResult:
    ...
    @property
    @pulumi.getter
    def production(self) -> builtins.bool:
        """
...
def get_deployment(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID or URL of the Deployment to read.
    :param builtins.str team_id: The Team ID to the Deployment belong to. Required when reading a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_deployment_output(id: Optional[pulumi.Input[builtins.str]] = None,
