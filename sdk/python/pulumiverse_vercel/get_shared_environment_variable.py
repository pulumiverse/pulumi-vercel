...
def get_shared_environment_variable(id: Optional[builtins.str] = None,
    ...
    :param builtins.str team_id: The ID of the Vercel team. Shared environment variables require a team.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['key'] = key
...
def get_shared_environment_variable_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           key: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           targets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
