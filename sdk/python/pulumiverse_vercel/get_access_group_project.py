...
def get_access_group_project(access_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str access_group_id: The Access Group ID.
    :param _builtins.str project_id: The Project ID.
    :param _builtins.str team_id: The ID of the team the Access Group Project should exist under. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
...
def get_access_group_project_output(access_group_id: Optional[pulumi.Input[_builtins.str]] = None,
                                    project_id: Optional[pulumi.Input[_builtins.str]] = None,
                                    team_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAccessGroupProjectResult]:
    """
    Provides information about an existing Access Group Project Assignment.
