...
def get_access_group_project(access_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str access_group_id: The Access Group ID.
    :param builtins.str project_id: The Project ID.
    :param builtins.str team_id: The ID of the team the Access Group Project should exist under. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
...
def get_access_group_project_output(access_group_id: Optional[pulumi.Input[builtins.str]] = None,
