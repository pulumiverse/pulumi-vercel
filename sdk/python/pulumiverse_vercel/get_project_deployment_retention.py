...
class GetProjectDeploymentRetentionResult:
    ...
    def expiration_canceled(self) -> builtins.str:
        """
    ...
    def expiration_errored(self) -> builtins.str:
        """
    ...
    def expiration_preview(self) -> builtins.str:
        """
    ...
    def expiration_production(self) -> builtins.str:
        """
...
def get_project_deployment_retention(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The ID of the Project for the retention policy
    :param builtins.str team_id: The ID of the Vercel team.
    """
    __args__ = dict()
...
def get_project_deployment_retention_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
