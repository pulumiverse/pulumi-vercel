...
class ProjectDeploymentRetentionArgs:
    def __init__(__self__, *,
                 ...
                 expiration_canceled: Optional[pulumi.Input[builtins.str]] = None,
                 expiration_errored: Optional[pulumi.Input[builtins.str]] = None,
                 expiration_preview: Optional[pulumi.Input[builtins.str]] = None,
                 expiration_production: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] project_id: The ID of the Project for the retention policy
        :param pulumi.Input[builtins.str] expiration_canceled: The retention period for canceled deployments. Should be one of '1m', '2m', '3m', '6m', '1y', 'unlimited'.
        :param pulumi.Input[builtins.str] expiration_errored: The retention period for errored deployments. Should be one of '1m', '2m', '3m', '6m', '1y', 'unlimited'.
        :param pulumi.Input[builtins.str] expiration_preview: The retention period for preview deployments. Should be one of '1m', '2m', '3m', '6m', '1y', 'unlimited'.
        :param pulumi.Input[builtins.str] expiration_production: The retention period for production deployments. Should be one of '1m', '2m', '3m', '6m', '1y', 'unlimited'.
        :param pulumi.Input[builtins.str] team_id: The ID of the Vercel team.
        """
    ...
    def expiration_canceled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def expiration_canceled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "expiration_canceled", value)

    @property
    @pulumi.getter(name="expirationErrored")
    def expiration_errored(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def expiration_errored(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "expiration_errored", value)

    @property
    @pulumi.getter(name="expirationPreview")
    def expiration_preview(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def expiration_preview(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "expiration_preview", value)

    @property
    @pulumi.getter(name="expirationProduction")
    def expiration_production(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def expiration_production(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("vercel:index/projectDeploymentRetention:ProjectDeploymentRetention")
class ProjectDeploymentRetention(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expiration_production: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectDeploymentRetention':
        """
    ...
    @property
    @pulumi.getter(name="expirationCanceled")
    def expiration_canceled(self) -> pulumi.Output[builtins.str]:
        """
        The retention period for canceled deployments. Should be one of '1m', '2m', '3m', '6m', '1y', 'unlimited'.
        """
        return pulumi.get(self, "expiration_canceled")
    ...
    @property
    @pulumi.getter(name="expirationErrored")
    def expiration_errored(self) -> pulumi.Output[builtins.str]:
        """
        The retention period for errored deployments. Should be one of '1m', '2m', '3m', '6m', '1y', 'unlimited'.
        """
        return pulumi.get(self, "expiration_errored")
    ...
    @property
    @pulumi.getter(name="expirationPreview")
    def expiration_preview(self) -> pulumi.Output[builtins.str]:
        """
        The retention period for preview deployments. Should be one of '1m', '2m', '3m', '6m', '1y', 'unlimited'.
        """
        return pulumi.get(self, "expiration_preview")
    ...
    @property
    @pulumi.getter(name="expirationProduction")
    def expiration_production(self) -> pulumi.Output[builtins.str]:
        """
        The retention period for production deployments. Should be one of '1m', '2m', '3m', '6m', '1y', 'unlimited'.
        """
        return pulumi.get(self, "expiration_production")
