...
class ProjectDeploymentRetentionArgs:
    def __init__(__self__, *,
                 ...
                 expiration_canceled: Optional[pulumi.Input[_builtins.str]] = None,
                 expiration_errored: Optional[pulumi.Input[_builtins.str]] = None,
                 expiration_preview: Optional[pulumi.Input[_builtins.str]] = None,
                 expiration_production: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] expiration_production: The retention period for production deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
    ...
    def expiration_canceled(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def expiration_canceled(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "expiration_canceled", value)

    @_builtins.property
    @pulumi.getter(name="expirationErrored")
    def expiration_errored(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def expiration_errored(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "expiration_errored", value)

    @_builtins.property
    @pulumi.getter(name="expirationPreview")
    def expiration_preview(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def expiration_preview(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "expiration_preview", value)

    @_builtins.property
    @pulumi.getter(name="expirationProduction")
    def expiration_production(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def expiration_production(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class ProjectDeploymentRetention(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expiration_production: Optional[pulumi.Input[_builtins.str]] = None,
            project_id: Optional[pulumi.Input[_builtins.str]] = None,
            team_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ProjectDeploymentRetention':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="expirationCanceled")
    def expiration_canceled(self) -> pulumi.Output[_builtins.str]:
        """
        The retention period for canceled deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
        """
        return pulumi.get(self, "expiration_canceled")
    ...
    @_builtins.property
    @pulumi.getter(name="expirationErrored")
    def expiration_errored(self) -> pulumi.Output[_builtins.str]:
        """
        The retention period for errored deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
        """
        return pulumi.get(self, "expiration_errored")
    ...
    @_builtins.property
    @pulumi.getter(name="expirationPreview")
    def expiration_preview(self) -> pulumi.Output[_builtins.str]:
        """
        The retention period for preview deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
        """
        return pulumi.get(self, "expiration_preview")
    ...
    @_builtins.property
    @pulumi.getter(name="expirationProduction")
    def expiration_production(self) -> pulumi.Output[_builtins.str]:
        """
        The retention period for production deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
        """
        return pulumi.get(self, "expiration_production")
