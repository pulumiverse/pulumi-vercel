...
class EdgeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name/slug of the Edge Config.
...
@pulumi.type_token("vercel:index/edgeConfig:EdgeConfig")
class EdgeConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EdgeConfig':
        """
