...
class TeamConfigArgs:
    def __init__(__self__, *,
                 avatar: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 email_domain: Optional[pulumi.Input[builtins.str]] = None,
                 enable_preview_feedback: Optional[pulumi.Input[builtins.str]] = None,
                 enable_production_feedback: Optional[pulumi.Input[builtins.str]] = None,
                 hide_ip_addresses: Optional[pulumi.Input[builtins.bool]] = None,
                 hide_ip_addresses_in_log_drains: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 preview_deployment_suffix: Optional[pulumi.Input[builtins.str]] = None,
                 remote_caching: Optional[pulumi.Input['TeamConfigRemoteCachingArgs']] = None,
                 saml: Optional[pulumi.Input['TeamConfigSamlArgs']] = None,
                 sensitive_environment_variable_policy: Optional[pulumi.Input[builtins.str]] = None,
                 slug: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TeamConfig resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] avatar: The `avatar` should be a the 'file' attribute from a get_file data source.
        :param pulumi.Input[builtins.str] description: A description of the team.
        :param pulumi.Input[builtins.str] email_domain: Hostname that'll be matched with emails on sign-up to automatically join the Team.
        :param pulumi.Input[builtins.str] enable_preview_feedback: Enables the Vercel Toolbar on your preview deployments: one of on, off or default.
        :param pulumi.Input[builtins.str] enable_production_feedback: Enables the Vercel Toolbar on your production deployments: one of on, off or default.
        :param pulumi.Input[builtins.bool] hide_ip_addresses: Indicates if ip addresses should be accessible in o11y tooling.
        :param pulumi.Input[builtins.bool] hide_ip_addresses_in_log_drains: Indicates if ip addresses should be accessible in log drains.
        :param pulumi.Input[builtins.str] name: The name of the team.
        :param pulumi.Input[builtins.str] preview_deployment_suffix: The hostname that is used as the preview deployment suffix.
        ...
        :param pulumi.Input[builtins.str] sensitive_environment_variable_policy: Ensures that all environment variables created by members of this team will be created as Sensitive Environment Variables which can only be decrypted by Vercel's deployment system.: one of on, off or default.
        :param pulumi.Input[builtins.str] slug: The slug of the team. Will be used in the URL of the team's dashboard.
        """
    ...
    @property
    @pulumi.getter
    def avatar(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    @avatar.setter
    def avatar(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def email_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @email_domain.setter
    def email_domain(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "email_domain", value)

    @property
    @pulumi.getter(name="enablePreviewFeedback")
    def enable_preview_feedback(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def enable_preview_feedback(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enable_preview_feedback", value)

    @property
    @pulumi.getter(name="enableProductionFeedback")
    def enable_production_feedback(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def enable_production_feedback(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enable_production_feedback", value)

    @property
    @pulumi.getter(name="hideIpAddresses")
    def hide_ip_addresses(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def hide_ip_addresses(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "hide_ip_addresses", value)

    @property
    @pulumi.getter(name="hideIpAddressesInLogDrains")
    def hide_ip_addresses_in_log_drains(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def hide_ip_addresses_in_log_drains(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def preview_deployment_suffix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def preview_deployment_suffix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sensitive_environment_variable_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sensitive_environment_variable_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TeamConfigState:
    def __init__(__self__, *,
                 ...
                 hide_ip_addresses: Optional[pulumi.Input[builtins.bool]] = None,
                 hide_ip_addresses_in_log_drains: Optional[pulumi.Input[builtins.bool]] = None,
                 invite_code: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 preview_deployment_suffix: Optional[pulumi.Input[builtins.str]] = None,
                 remote_caching: Optional[pulumi.Input['TeamConfigRemoteCachingArgs']] = None,
                 saml: Optional[pulumi.Input['TeamConfigSamlArgs']] = None,
        ...
        :param pulumi.Input[builtins.bool] hide_ip_addresses: Indicates if ip addresses should be accessible in o11y tooling.
        :param pulumi.Input[builtins.bool] hide_ip_addresses_in_log_drains: Indicates if ip addresses should be accessible in log drains.
        :param pulumi.Input[builtins.str] invite_code: A code that can be used to join this team. Only visible to Team owners.
        :param pulumi.Input[builtins.str] name: The name of the team.
        :param pulumi.Input[builtins.str] preview_deployment_suffix: The hostname that is used as the preview deployment suffix.
        :param pulumi.Input['TeamConfigRemoteCachingArgs'] remote_caching: Configuration for Remote Caching.
        :param pulumi.Input['TeamConfigSamlArgs'] saml: Configuration for SAML authentication.
    ...
    def invite_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @invite_code.setter
    def invite_code(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("vercel:index/teamConfig:TeamConfig")
class TeamConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            saml: Optional[pulumi.Input[Union['TeamConfigSamlArgs', 'TeamConfigSamlArgsDict']]] = None,
            sensitive_environment_variable_policy: Optional[pulumi.Input[builtins.str]] = None,
            slug: Optional[pulumi.Input[builtins.str]] = None) -> 'TeamConfig':
        """
    ...
    @property
    @pulumi.getter
    def avatar(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        The `avatar` should be a the 'file' attribute from a get_file data source.
        """
        return pulumi.get(self, "avatar")
    ...
    @property
    @pulumi.getter(name="emailDomain")
    def email_domain(self) -> pulumi.Output[builtins.str]:
        """
        Hostname that'll be matched with emails on sign-up to automatically join the Team.
        """
        return pulumi.get(self, "email_domain")
    ...
    @property
    @pulumi.getter(name="enablePreviewFeedback")
    def enable_preview_feedback(self) -> pulumi.Output[builtins.str]:
        """
        Enables the Vercel Toolbar on your preview deployments: one of on, off or default.
        """
        return pulumi.get(self, "enable_preview_feedback")
    ...
    @property
    @pulumi.getter(name="enableProductionFeedback")
    def enable_production_feedback(self) -> pulumi.Output[builtins.str]:
        """
        Enables the Vercel Toolbar on your production deployments: one of on, off or default.
        """
        return pulumi.get(self, "enable_production_feedback")
    ...
    @property
    @pulumi.getter(name="hideIpAddresses")
    def hide_ip_addresses(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if ip addresses should be accessible in o11y tooling.
        """
        return pulumi.get(self, "hide_ip_addresses")
    ...
    @property
    @pulumi.getter(name="hideIpAddressesInLogDrains")
    def hide_ip_addresses_in_log_drains(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if ip addresses should be accessible in log drains.
        """
        return pulumi.get(self, "hide_ip_addresses_in_log_drains")
    ...
    @property
    @pulumi.getter(name="inviteCode")
    def invite_code(self) -> pulumi.Output[builtins.str]:
        """
        A code that can be used to join this team. Only visible to Team owners.
        """
        return pulumi.get(self, "invite_code")
    ...
    @property
    @pulumi.getter(name="previewDeploymentSuffix")
    def preview_deployment_suffix(self) -> pulumi.Output[builtins.str]:
        """
        The hostname that is used as the preview deployment suffix.
        """
        return pulumi.get(self, "preview_deployment_suffix")
    ...
    @property
    @pulumi.getter(name="sensitiveEnvironmentVariablePolicy")
    def sensitive_environment_variable_policy(self) -> pulumi.Output[builtins.str]:
        """
        Ensures that all environment variables created by members of this team will be created as Sensitive Environment Variables which can only be decrypted by Vercel's deployment system.: one of on, off or default.
        """
        return pulumi.get(self, "sensitive_environment_variable_policy")
