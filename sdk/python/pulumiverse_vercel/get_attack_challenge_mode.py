...
def get_attack_challenge_mode(project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: The ID of the Project to adjust the CPU for.
...
def get_attack_challenge_mode_output(project_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     team_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAttackChallengeModeResult]:
    """
    Provides an Attack Challenge Mode resource.
