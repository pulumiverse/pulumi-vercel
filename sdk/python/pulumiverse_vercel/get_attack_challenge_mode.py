...
def get_attack_challenge_mode(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The ID of the Project to adjust the CPU for.
    :param builtins.str team_id: The ID of the team the Project exists under. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
...
def get_attack_challenge_mode_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
