...
class ProjectArgs:
    def __init__(__self__, *,
                 auto_assign_custom_domains: Optional[pulumi.Input[builtins.bool]] = None,
                 automatically_expose_system_environment_variables: Optional[pulumi.Input[builtins.bool]] = None,
                 build_command: Optional[pulumi.Input[builtins.str]] = None,
                 customer_success_code_visibility: Optional[pulumi.Input[builtins.bool]] = None,
                 dev_command: Optional[pulumi.Input[builtins.str]] = None,
                 directory_listing: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_affected_projects_deployments: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_preview_feedback: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_production_feedback: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 function_failover: Optional[pulumi.Input[builtins.bool]] = None,
                 git_comments: Optional[pulumi.Input['ProjectGitCommentsArgs']] = None,
                 git_fork_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 git_lfs: Optional[pulumi.Input[builtins.bool]] = None,
                 git_repository: Optional[pulumi.Input['ProjectGitRepositoryArgs']] = None,
                 ignore_command: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 on_demand_concurrent_builds: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 preview_comments: Optional[pulumi.Input[builtins.bool]] = None,
                 prioritise_production_builds: Optional[pulumi.Input[builtins.bool]] = None,
                 protection_bypass_for_automation: Optional[pulumi.Input[builtins.bool]] = None,
                 protection_bypass_for_automation_secret: Optional[pulumi.Input[builtins.str]] = None,
                 public_source: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 serverless_function_region: Optional[pulumi.Input[builtins.str]] = None,
                 skew_protection: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_assign_custom_domains: Automatically assign custom production domains after each Production deployment via merge to the production branch or Vercel CLI deploy with --prod. Defaults to `true`
        :param pulumi.Input[builtins.bool] automatically_expose_system_environment_variables: Vercel provides a set of Environment Variables that are automatically populated by the System, such as the URL of the Deployment or the name of the Git branch deployed. To expose them to your Deployments, enable this field
        :param pulumi.Input[builtins.str] build_command: The build command for this project. If omitted, this value will be automatically detected.
        :param pulumi.Input[builtins.bool] customer_success_code_visibility: Allows Vercel Customer Support to inspect all Deployments' source code in this project to assist with debugging.
        :param pulumi.Input[builtins.str] dev_command: The dev command for this project. If omitted, this value will be automatically detected.
        :param pulumi.Input[builtins.bool] directory_listing: If no index file is present within a directory, the directory contents will be displayed.
        :param pulumi.Input[builtins.bool] enable_affected_projects_deployments: When enabled, Vercel will automatically deploy all projects that are affected by a change to this project.
        :param pulumi.Input[builtins.bool] enable_preview_feedback: Enables the Vercel Toolbar on your preview deployments.
        :param pulumi.Input[builtins.bool] enable_production_feedback: Enables the Vercel Toolbar on your production deployments: one of on, off or default.
        ...
        :param pulumi.Input[builtins.str] framework: The framework that is being used for this project. If omitted, no framework is selected.
        :param pulumi.Input[builtins.bool] function_failover: Automatically failover Serverless Functions to the nearest region. You can customize regions through vercel.json. A new Deployment is required for your changes to take effect.
        :param pulumi.Input['ProjectGitCommentsArgs'] git_comments: Configuration for Git Comments.
        :param pulumi.Input[builtins.bool] git_fork_protection: Ensures that pull requests targeting your Git repository must be authorized by a member of your Team before deploying if your Project has Environment Variables or if the pull request includes a change to vercel.json. Defaults to `true`.
        :param pulumi.Input[builtins.bool] git_lfs: Enables Git LFS support. Git LFS replaces large files such as audio samples, videos, datasets, and graphics with text pointers inside Git, while storing the file contents on a remote server like GitHub.com or GitHub Enterprise.
        ...
        :param pulumi.Input[builtins.str] ignore_command: When a commit is pushed to the Git repository that is connected with your Project, its SHA will determine if a new Build has to be issued. If the SHA was deployed before, no new Build will be issued. You can customize this behavior with a command that exits with code 1 (new Build needed) or code 0.
        :param pulumi.Input[builtins.str] install_command: The install command for this project. If omitted, this value will be automatically detected.
        :param pulumi.Input[builtins.str] name: The desired name for the project.
        :param pulumi.Input[builtins.str] node_version: The version of Node.js that is used in the Build Step and for Serverless Functions. A new Deployment is required for your changes to take effect.
        :param pulumi.Input['ProjectOidcTokenConfigArgs'] oidc_token_config: Configuration for OpenID Connect (OIDC) tokens.
        :param pulumi.Input[builtins.bool] on_demand_concurrent_builds: Instantly scale build capacity to skip the queue, even if all build slots are in use. You can also choose a larger build machine; charges apply per minute if it exceeds your team's default.
        ...
        :param pulumi.Input[builtins.str] output_directory: The output directory of the project. If omitted, this value will be automatically detected.
        ...
        :param pulumi.Input[builtins.bool] preview_comments: Enables the Vercel Toolbar on your preview deployments.
        :param pulumi.Input[builtins.bool] prioritise_production_builds: If enabled, builds for the Production environment will be prioritized over Preview environments.
        :param pulumi.Input[builtins.bool] protection_bypass_for_automation: Allow automation services to bypass Deployment Protection on this project when using an HTTP header named `x-vercel-protection-bypass` with a value of the `protection_bypass_for_automation_secret` field.
        :param pulumi.Input[builtins.str] protection_bypass_for_automation_secret: If `protection_bypass_for_automation` is enabled, optionally set this value to specify a 32 character secret, otherwise a secret will be generated.
        :param pulumi.Input[builtins.bool] public_source: By default, visitors to the `/_logs` and `/_src` paths of your Production and Preview Deployments must log in with Vercel (requires being a member of your team) to see the Source, Logs and Deployment Status of your project. Setting `public_source` to `true` disables this behaviour, meaning the Source, Logs and Deployment Status can be publicly viewed.
        :param pulumi.Input['ProjectResourceConfigArgs'] resource_config: Resource Configuration for the project.
        :param pulumi.Input[builtins.str] root_directory: The name of a directory or relative path to the source code of your project. If omitted, it will default to the project root.
        :param pulumi.Input[builtins.str] serverless_function_region: The region on Vercel's network to which your Serverless Functions are deployed. It should be close to any data source your Serverless Function might depend on. A new Deployment is required for your changes to take effect. Please see [Vercel's documentation](https://vercel.com/docs/concepts/edge-network/regions) for a full list of regions.
        :param pulumi.Input[builtins.str] skew_protection: Ensures that outdated clients always fetch the correct version for a given deployment. This value defines how long Vercel keeps Skew Protection active.
        :param pulumi.Input[builtins.str] team_id: The team ID to add the project to. Required when configuring a team resource if a default team has not been set in the provider.
    ...
    def auto_assign_custom_domains(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_assign_custom_domains(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_assign_custom_domains", value)

    @property
    @pulumi.getter(name="automaticallyExposeSystemEnvironmentVariables")
    def automatically_expose_system_environment_variables(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def automatically_expose_system_environment_variables(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def customer_success_code_visibility(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def customer_success_code_visibility(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "customer_success_code_visibility", value)

    @property
    @pulumi.getter(name="devCommand")
    def dev_command(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dev_command.setter
    def dev_command(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dev_command", value)

    @property
    @pulumi.getter(name="directoryListing")
    def directory_listing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def directory_listing(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "directory_listing", value)

    @property
    @pulumi.getter(name="enableAffectedProjectsDeployments")
    def enable_affected_projects_deployments(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_affected_projects_deployments(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_affected_projects_deployments", value)

    @property
    @pulumi.getter(name="enablePreviewFeedback")
    def enable_preview_feedback(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_preview_feedback(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_preview_feedback", value)

    @property
    @pulumi.getter(name="enableProductionFeedback")
    def enable_production_feedback(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_production_feedback(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def function_failover(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def function_failover(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def git_fork_protection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def git_fork_protection(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "git_fork_protection", value)

    @property
    @pulumi.getter(name="gitLfs")
    def git_lfs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @git_lfs.setter
    def git_lfs(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ignore_command(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ignore_command(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def on_demand_concurrent_builds(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def on_demand_concurrent_builds(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def preview_comments(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables the Vercel Toolbar on your preview deployments.
        """
    ...
    def preview_comments(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "preview_comments", value)

    @property
    @pulumi.getter(name="prioritiseProductionBuilds")
    def prioritise_production_builds(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def prioritise_production_builds(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "prioritise_production_builds", value)

    @property
    @pulumi.getter(name="protectionBypassForAutomation")
    def protection_bypass_for_automation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def protection_bypass_for_automation(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "protection_bypass_for_automation", value)

    @property
    @pulumi.getter(name="protectionBypassForAutomationSecret")
    def protection_bypass_for_automation_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def protection_bypass_for_automation_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "protection_bypass_for_automation_secret", value)

    @property
    @pulumi.getter(name="publicSource")
    def public_source(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def public_source(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def serverless_function_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def serverless_function_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "serverless_function_region", value)

    @property
    @pulumi.getter(name="skewProtection")
    def skew_protection(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def skew_protection(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("vercel:index/project:Project")
class Project(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoAssignCustomDomains")
    def auto_assign_custom_domains(self) -> pulumi.Output[builtins.bool]:
        """
        Automatically assign custom production domains after each Production deployment via merge to the production branch or Vercel CLI deploy with --prod. Defaults to `true`
        """
        return pulumi.get(self, "auto_assign_custom_domains")
    ...
    @property
    @pulumi.getter(name="automaticallyExposeSystemEnvironmentVariables")
    def automatically_expose_system_environment_variables(self) -> pulumi.Output[builtins.bool]:
        """
        Vercel provides a set of Environment Variables that are automatically populated by the System, such as the URL of the Deployment or the name of the Git branch deployed. To expose them to your Deployments, enable this field
        """
        return pulumi.get(self, "automatically_expose_system_environment_variables")
    ...
    @property
    @pulumi.getter(name="buildCommand")
    def build_command(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The build command for this project. If omitted, this value will be automatically detected.
        """
        return pulumi.get(self, "build_command")
    ...
    @property
    @pulumi.getter(name="customerSuccessCodeVisibility")
    def customer_success_code_visibility(self) -> pulumi.Output[builtins.bool]:
        """
        Allows Vercel Customer Support to inspect all Deployments' source code in this project to assist with debugging.
        """
        return pulumi.get(self, "customer_success_code_visibility")
    ...
    @property
    @pulumi.getter(name="devCommand")
    def dev_command(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The dev command for this project. If omitted, this value will be automatically detected.
        """
        return pulumi.get(self, "dev_command")
    ...
    @property
    @pulumi.getter(name="directoryListing")
    def directory_listing(self) -> pulumi.Output[builtins.bool]:
        """
        If no index file is present within a directory, the directory contents will be displayed.
        """
        return pulumi.get(self, "directory_listing")
    ...
    @property
    @pulumi.getter(name="enableAffectedProjectsDeployments")
    def enable_affected_projects_deployments(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When enabled, Vercel will automatically deploy all projects that are affected by a change to this project.
        """
        return pulumi.get(self, "enable_affected_projects_deployments")
    ...
    @property
    @pulumi.getter(name="enablePreviewFeedback")
    def enable_preview_feedback(self) -> pulumi.Output[builtins.bool]:
        """
        Enables the Vercel Toolbar on your preview deployments.
        """
        return pulumi.get(self, "enable_preview_feedback")
    ...
    @property
    @pulumi.getter(name="enableProductionFeedback")
    def enable_production_feedback(self) -> pulumi.Output[builtins.bool]:
        """
        Enables the Vercel Toolbar on your production deployments: one of on, off or default.
        """
        return pulumi.get(self, "enable_production_feedback")
    ...
    @property
    @pulumi.getter(name="functionFailover")
    def function_failover(self) -> pulumi.Output[builtins.bool]:
        """
        Automatically failover Serverless Functions to the nearest region. You can customize regions through vercel.json. A new Deployment is required for your changes to take effect.
        """
        return pulumi.get(self, "function_failover")
    ...
    @property
    @pulumi.getter(name="gitForkProtection")
    def git_fork_protection(self) -> pulumi.Output[builtins.bool]:
        """
        Ensures that pull requests targeting your Git repository must be authorized by a member of your Team before deploying if your Project has Environment Variables or if the pull request includes a change to vercel.json. Defaults to `true`.
        """
        return pulumi.get(self, "git_fork_protection")
    ...
    @property
    @pulumi.getter(name="gitLfs")
    def git_lfs(self) -> pulumi.Output[builtins.bool]:
        """
        Enables Git LFS support. Git LFS replaces large files such as audio samples, videos, datasets, and graphics with text pointers inside Git, while storing the file contents on a remote server like GitHub.com or GitHub Enterprise.
        """
        return pulumi.get(self, "git_lfs")
    ...
    @property
    @pulumi.getter(name="ignoreCommand")
    def ignore_command(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When a commit is pushed to the Git repository that is connected with your Project, its SHA will determine if a new Build has to be issued. If the SHA was deployed before, no new Build will be issued. You can customize this behavior with a command that exits with code 1 (new Build needed) or code 0.
        """
        return pulumi.get(self, "ignore_command")
    ...
    @property
    @pulumi.getter(name="installCommand")
    def install_command(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The install command for this project. If omitted, this value will be automatically detected.
        """
        return pulumi.get(self, "install_command")
    ...
    @property
    @pulumi.getter(name="onDemandConcurrentBuilds")
    def on_demand_concurrent_builds(self) -> pulumi.Output[builtins.bool]:
        """
        Instantly scale build capacity to skip the queue, even if all build slots are in use. You can also choose a larger build machine; charges apply per minute if it exceeds your team's default.
        """
        return pulumi.get(self, "on_demand_concurrent_builds")
    ...
    @property
    @pulumi.getter(name="outputDirectory")
    def output_directory(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The output directory of the project. If omitted, this value will be automatically detected.
        """
        return pulumi.get(self, "output_directory")
    ...
    @pulumi.getter(name="previewComments")
    @_utilities.deprecated("""Use `enable_preview_feedback` instead. This attribute will be removed in a future version.""")
    def preview_comments(self) -> pulumi.Output[builtins.bool]:
        """
        Enables the Vercel Toolbar on your preview deployments.
        """
        return pulumi.get(self, "preview_comments")
    ...
    @property
    @pulumi.getter(name="prioritiseProductionBuilds")
    def prioritise_production_builds(self) -> pulumi.Output[builtins.bool]:
        """
        If enabled, builds for the Production environment will be prioritized over Preview environments.
        """
        return pulumi.get(self, "prioritise_production_builds")
    ...
    @property
    @pulumi.getter(name="protectionBypassForAutomation")
    def protection_bypass_for_automation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Allow automation services to bypass Deployment Protection on this project when using an HTTP header named `x-vercel-protection-bypass` with a value of the `protection_bypass_for_automation_secret` field.
        """
        return pulumi.get(self, "protection_bypass_for_automation")
    ...
    @property
    @pulumi.getter(name="protectionBypassForAutomationSecret")
    def protection_bypass_for_automation_secret(self) -> pulumi.Output[builtins.str]:
        """
        If `protection_bypass_for_automation` is enabled, optionally set this value to specify a 32 character secret, otherwise a secret will be generated.
        """
        return pulumi.get(self, "protection_bypass_for_automation_secret")
    ...
    @property
    @pulumi.getter(name="publicSource")
    def public_source(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        By default, visitors to the `/_logs` and `/_src` paths of your Production and Preview Deployments must log in with Vercel (requires being a member of your team) to see the Source, Logs and Deployment Status of your project. Setting `public_source` to `true` disables this behaviour, meaning the Source, Logs and Deployment Status can be publicly viewed.
        """
        return pulumi.get(self, "public_source")
    ...
    @property
    @pulumi.getter(name="rootDirectory")
    def root_directory(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of a directory or relative path to the source code of your project. If omitted, it will default to the project root.
        """
        return pulumi.get(self, "root_directory")
    ...
    @property
    @pulumi.getter(name="serverlessFunctionRegion")
    def serverless_function_region(self) -> pulumi.Output[builtins.str]:
        """
        The region on Vercel's network to which your Serverless Functions are deployed. It should be close to any data source your Serverless Function might depend on. A new Deployment is required for your changes to take effect. Please see [Vercel's documentation](https://vercel.com/docs/concepts/edge-network/regions) for a full list of regions.
        """
        return pulumi.get(self, "serverless_function_region")
    ...
    @property
    @pulumi.getter(name="skewProtection")
    def skew_protection(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Ensures that outdated clients always fetch the correct version for a given deployment. This value defines how long Vercel keeps Skew Protection active.
        """
        return pulumi.get(self, "skew_protection")
