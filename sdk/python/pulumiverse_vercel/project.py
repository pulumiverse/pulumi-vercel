...
class ProjectArgs:
    def __init__(__self__, *,
                 auto_assign_custom_domains: Optional[pulumi.Input[_builtins.bool]] = None,
                 automatically_expose_system_environment_variables: Optional[pulumi.Input[_builtins.bool]] = None,
                 build_command: Optional[pulumi.Input[_builtins.str]] = None,
                 build_machine_type: Optional[pulumi.Input[_builtins.str]] = None,
                 customer_success_code_visibility: Optional[pulumi.Input[_builtins.bool]] = None,
                 dev_command: Optional[pulumi.Input[_builtins.str]] = None,
                 directory_listing: Optional[pulumi.Input[_builtins.bool]] = None,
                 enable_affected_projects_deployments: Optional[pulumi.Input[_builtins.bool]] = None,
                 enable_preview_feedback: Optional[pulumi.Input[_builtins.bool]] = None,
                 enable_production_feedback: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 function_failover: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 serverless_function_region: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: The desired name for the project.
        :param pulumi.Input[_builtins.str] node_version: The version of Node.js that is used in the Build Step and for Serverless Functions. A new Deployment is required for your changes to take effect.
        ...
        :param pulumi.Input[_builtins.str] serverless_function_region: The region on Vercel's network to which your Serverless Functions are deployed. It should be close to any data source your Serverless Function might depend on. A new Deployment is required for your changes to take effect. Please see [Vercel's documentation](https://vercel.com/docs/concepts/edge-network/regions) for a full list of regions.
    ...
    def auto_assign_custom_domains(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def auto_assign_custom_domains(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "auto_assign_custom_domains", value)

    @_builtins.property
    @pulumi.getter(name="automaticallyExposeSystemEnvironmentVariables")
    def automatically_expose_system_environment_variables(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def automatically_expose_system_environment_variables(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def build_machine_type(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "build_machine_type", value)

    @_builtins.property
    @pulumi.getter(name="customerSuccessCodeVisibility")
    def customer_success_code_visibility(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def customer_success_code_visibility(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "customer_success_code_visibility", value)

    @_builtins.property
    @pulumi.getter(name="devCommand")
    def dev_command(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @dev_command.setter
    def dev_command(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "dev_command", value)

    @_builtins.property
    @pulumi.getter(name="directoryListing")
    def directory_listing(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def directory_listing(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "directory_listing", value)

    @_builtins.property
    @pulumi.getter(name="enableAffectedProjectsDeployments")
    def enable_affected_projects_deployments(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def enable_affected_projects_deployments(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "enable_affected_projects_deployments", value)

    @_builtins.property
    @pulumi.getter(name="enablePreviewFeedback")
    def enable_preview_feedback(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def enable_preview_feedback(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "enable_preview_feedback", value)

    @_builtins.property
    @pulumi.getter(name="enableProductionFeedback")
    def enable_production_feedback(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def enable_production_feedback(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def function_failover(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def function_failover(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def git_fork_protection(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def git_fork_protection(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "git_fork_protection", value)

    @_builtins.property
    @pulumi.getter(name="gitLfs")
    def git_lfs(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @git_lfs.setter
    def git_lfs(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def ignore_command(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def ignore_command(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def on_demand_concurrent_builds(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def on_demand_concurrent_builds(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def preview_comments(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        Enables the Vercel Toolbar on your preview deployments.
        """
    ...
    def preview_deployments_disabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def preview_deployments_disabled(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "preview_deployments_disabled", value)

    @_builtins.property
    @pulumi.getter(name="prioritiseProductionBuilds")
    def prioritise_production_builds(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    @_utilities.deprecated("""This attribute is deprecated and no longer has any effect. The public source feature has been removed from Vercel, so this value is ignored and no longer sent to the API. It will be removed in a future major version of this provider.""")
    ...
    def public_source(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def serverless_function_region(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def serverless_function_region(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "serverless_function_region", value)

    @_builtins.property
    @pulumi.getter(name="skewProtection")
    def skew_protection(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def skew_protection(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class Project(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="autoAssignCustomDomains")
    def auto_assign_custom_domains(self) -> pulumi.Output[_builtins.bool]:
        """
        Automatically assign custom production domains after each Production deployment via merge to the production branch or Vercel CLI deploy with --prod. Defaults to `true`
        """
        return pulumi.get(self, "auto_assign_custom_domains")
    ...
    @_builtins.property
    @pulumi.getter(name="automaticallyExposeSystemEnvironmentVariables")
    def automatically_expose_system_environment_variables(self) -> pulumi.Output[_builtins.bool]:
        """
        Vercel provides a set of Environment Variables that are automatically populated by the System, such as the URL of the Deployment or the name of the Git branch deployed. To expose them to your Deployments, enable this field
        """
        return pulumi.get(self, "automatically_expose_system_environment_variables")
    ...
    @_builtins.property
    @pulumi.getter(name="buildCommand")
    def build_command(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The build command for this project. If omitted, this value will be automatically detected.
        """
        return pulumi.get(self, "build_command")
    ...
    @_builtins.property
    @pulumi.getter(name="customerSuccessCodeVisibility")
    def customer_success_code_visibility(self) -> pulumi.Output[_builtins.bool]:
        """
        Allows Vercel Customer Support to inspect all Deployments' source code in this project to assist with debugging.
        """
        return pulumi.get(self, "customer_success_code_visibility")
    ...
    @_builtins.property
    @pulumi.getter(name="devCommand")
    def dev_command(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The dev command for this project. If omitted, this value will be automatically detected.
        """
        return pulumi.get(self, "dev_command")
    ...
    @_builtins.property
    @pulumi.getter(name="directoryListing")
    def directory_listing(self) -> pulumi.Output[_builtins.bool]:
        """
        If no index file is present within a directory, the directory contents will be displayed.
        """
        return pulumi.get(self, "directory_listing")
    ...
    @_builtins.property
    @pulumi.getter(name="enableAffectedProjectsDeployments")
    def enable_affected_projects_deployments(self) -> pulumi.Output[_builtins.bool]:
        """
        When enabled, Vercel will automatically deploy all projects that are affected by a change to this project.
        """
        return pulumi.get(self, "enable_affected_projects_deployments")
    ...
    @_builtins.property
    @pulumi.getter(name="enablePreviewFeedback")
    def enable_preview_feedback(self) -> pulumi.Output[_builtins.bool]:
        """
        Enables the Vercel Toolbar on your preview deployments.
        """
        return pulumi.get(self, "enable_preview_feedback")
    ...
    @_builtins.property
    @pulumi.getter(name="enableProductionFeedback")
    def enable_production_feedback(self) -> pulumi.Output[_builtins.bool]:
        """
        Enables the Vercel Toolbar on your production deployments: one of on, off or default.
        """
        return pulumi.get(self, "enable_production_feedback")
    ...
    @_builtins.property
    @pulumi.getter(name="functionFailover")
    def function_failover(self) -> pulumi.Output[_builtins.bool]:
        """
        Automatically failover Serverless Functions to the nearest region. You can customize regions through vercel.json. A new Deployment is required for your changes to take effect.
        """
        return pulumi.get(self, "function_failover")
    ...
    @_builtins.property
    @pulumi.getter(name="gitForkProtection")
    def git_fork_protection(self) -> pulumi.Output[_builtins.bool]:
        """
        Ensures that pull requests targeting your Git repository must be authorized by a member of your Team before deploying if your Project has Environment Variables or if the pull request includes a change to vercel.json. Defaults to `true`.
        """
        return pulumi.get(self, "git_fork_protection")
    ...
    @_builtins.property
    @pulumi.getter(name="gitLfs")
    def git_lfs(self) -> pulumi.Output[_builtins.bool]:
        """
        Enables Git LFS support. Git LFS replaces large files such as audio samples, videos, datasets, and graphics with text pointers inside Git, while storing the file contents on a remote server like GitHub.com or GitHub Enterprise.
        """
        return pulumi.get(self, "git_lfs")
    ...
    @_builtins.property
    @pulumi.getter(name="ignoreCommand")
    def ignore_command(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        When a commit is pushed to the Git repository that is connected with your Project, its SHA will determine if a new Build has to be issued. If the SHA was deployed before, no new Build will be issued. You can customize this behavior with a command that exits with code 1 (new Build needed) or code 0.
        """
        return pulumi.get(self, "ignore_command")
    ...
    @_builtins.property
    @pulumi.getter(name="onDemandConcurrentBuilds")
    def on_demand_concurrent_builds(self) -> pulumi.Output[_builtins.bool]:
        """
        Instantly scale build capacity to skip the queue, even if all build slots are in use. You can also choose a larger build machine; charges apply per minute if it exceeds your team's default.
        """
        return pulumi.get(self, "on_demand_concurrent_builds")
    ...
    @_builtins.property
    @pulumi.getter(name="outputDirectory")
    def output_directory(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The output directory of the project. If omitted, this value will be automatically detected.
        """
        return pulumi.get(self, "output_directory")
    ...
    @pulumi.getter(name="previewComments")
    @_utilities.deprecated("""Use `enable_preview_feedback` instead. This attribute will be removed in a future version.""")
    def preview_comments(self) -> pulumi.Output[_builtins.bool]:
        """
        Enables the Vercel Toolbar on your preview deployments.
        """
        return pulumi.get(self, "preview_comments")
    ...
    @_builtins.property
    @pulumi.getter(name="previewDeploymentsDisabled")
    def preview_deployments_disabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Disable creation of Preview Deployments for this project.
        """
        return pulumi.get(self, "preview_deployments_disabled")
    ...
    @_builtins.property
    @pulumi.getter(name="prioritiseProductionBuilds")
    def prioritise_production_builds(self) -> pulumi.Output[_builtins.bool]:
        """
        If enabled, builds for the Production environment will be prioritized over Preview environments.
        """
        return pulumi.get(self, "prioritise_production_builds")
    ...
    @_builtins.property
    @pulumi.getter(name="rootDirectory")
    def root_directory(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of a directory or relative path to the source code of your project. If omitted, it will default to the project root.
        """
        return pulumi.get(self, "root_directory")
    ...
    @pulumi.getter(name="serverlessFunctionRegion")
    @_utilities.deprecated("""This attribute is deprecated. Please use resource_config.function_default_regions instead.""")
    def serverless_function_region(self) -> pulumi.Output[_builtins.str]:
        """
        The region on Vercel's network to which your Serverless Functions are deployed. It should be close to any data source your Serverless Function might depend on. A new Deployment is required for your changes to take effect. Please see [Vercel's documentation](https://vercel.com/docs/concepts/edge-network/regions) for a full list of regions.
        """
        return pulumi.get(self, "serverless_function_region")
    ...
    @_builtins.property
    @pulumi.getter(name="skewProtection")
    def skew_protection(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Ensures that outdated clients always fetch the correct version for a given deployment. This value defines how long Vercel keeps Skew Protection active.
        """
        return pulumi.get(self, "skew_protection")
