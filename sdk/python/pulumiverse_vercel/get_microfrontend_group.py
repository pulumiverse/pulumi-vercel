...
def get_microfrontend_group(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: A unique identifier for the group of microfrontends. Example: mfe_12HKQaOmR5t5Uy6vdcQsNIiZgHGB
    :param builtins.str team_id: The team ID to add the project to. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_microfrontend_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
