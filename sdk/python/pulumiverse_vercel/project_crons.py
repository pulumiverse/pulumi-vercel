...
class ProjectCronsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: Whether crons are enabled for the project.
        :param pulumi.Input[str] project_id: The ID of the Project to toggle crons for.
...
class ProjectCrons(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[bool]] = None,
            project_id: Optional[pulumi.Input[str]] = None,
            team_id: Optional[pulumi.Input[str]] = None) -> 'ProjectCrons':
        """
