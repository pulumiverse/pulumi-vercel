...
class GetEndpointVerificationResult:
    ...
    def verification_code(self) -> _builtins.str:
        """
...
def get_endpoint_verification(team_id: Optional[_builtins.str] = None,
...
def get_endpoint_verification_output(team_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEndpointVerificationResult]:
    """
    Provides a verification code that can be used to prove ownership over an API.
