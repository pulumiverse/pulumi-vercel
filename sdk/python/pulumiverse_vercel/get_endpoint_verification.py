...
def get_endpoint_verification(team_id: Optional[builtins.str] = None,
...
def get_endpoint_verification_output(team_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
