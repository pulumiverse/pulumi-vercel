...
class AccessGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] team_id: The ID of the team the Access Group should exist under. Required when configuring a team resource if a default team has not been set in the provider.
        """
        if name is not None:
...
@pulumi.type_token("vercel:index/accessGroup:AccessGroup")
class AccessGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessGroup':
        """
