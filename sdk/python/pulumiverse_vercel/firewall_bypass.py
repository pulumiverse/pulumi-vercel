...
class FirewallBypassArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain: The domain to configure the bypass rule for.
        :param pulumi.Input[builtins.str] project_id: The ID of the Project to assign the bypass rule to
        :param pulumi.Input[builtins.str] source_ip: The source IP address to configure the bypass rule for.
...
@pulumi.type_token("vercel:index/firewallBypass:FirewallBypass")
class FirewallBypass(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        bypass_targeted = vercel.FirewallBypass("bypassTargeted",
            project_id=example.id,
            source_ip="5.6.7.8",
            domain="my-production-domain.com")
        bypass_cidr = vercel.FirewallBypass("bypassCidr",
            project_id=example.id,
            source_ip="52.33.44.0/24",
            domain="my-production-domain.com")
        bypass_all = vercel.FirewallBypass("bypassAll",
            project_id=example.id,
            source_ip="52.33.44.0/24",
            domain="*")
        ```
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            source_ip: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FirewallBypass':
        """
