...
class FirewallConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: The ID of the project this configuration belongs to.
        :param pulumi.Input[builtins.bool] enabled: Whether firewall is enabled or not.
        ...
        :param pulumi.Input[builtins.str] team_id: The ID of the team this project belongs to.
        """
...
class FirewallConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Union['FirewallConfigRulesArgs', 'FirewallConfigRulesArgsDict']]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FirewallConfig':
        """
