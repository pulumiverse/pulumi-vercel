...
class MicrofrontendGroupMembershipArgs:
    def __init__(__self__, *,
                 microfrontend_group_id: pulumi.Input[builtins.str],
                 project_id: pulumi.Input[builtins.str],
                 default_route: Optional[pulumi.Input[builtins.str]] = None,
                 route_observability_to_this_project: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] microfrontend_group_id: The ID of the microfrontend group.
        ...
        :param pulumi.Input[builtins.bool] route_observability_to_this_project: Whether the project is route observability for this project. If dalse, the project will be route observability for all projects to the default project.
        :param pulumi.Input[builtins.str] team_id: The team ID to add the microfrontend group to. Required when configuring a team resource if a default team has not been set in the provider.
        """
    ...
    def microfrontend_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def microfrontend_group_id(self, value: pulumi.Input[builtins.str]):
    ...
    def route_observability_to_this_project(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def route_observability_to_this_project(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MicrofrontendGroupMembershipState:
    def __init__(__self__, *,
                 default_route: Optional[pulumi.Input[builtins.str]] = None,
                 microfrontend_group_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="microfrontendGroupId")
    def microfrontend_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the microfrontend group.
        """
        return pulumi.get(self, "microfrontend_group_id")
    ...
    @microfrontend_group_id.setter
    def microfrontend_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "microfrontend_group_id", value)
...
@pulumi.type_token("vercel:index/microfrontendGroupMembership:MicrofrontendGroupMembership")
class MicrofrontendGroupMembership(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            route_observability_to_this_project: Optional[pulumi.Input[builtins.bool]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MicrofrontendGroupMembership':
        """
    ...
    @property
    @pulumi.getter(name="defaultRoute")
    def default_route(self) -> pulumi.Output[builtins.str]:
        """
        The default route for the project. Used for the screenshot of deployments.
        """
        return pulumi.get(self, "default_route")
    ...
    @property
    @pulumi.getter(name="microfrontendGroupId")
    def microfrontend_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the microfrontend group.
        """
        return pulumi.get(self, "microfrontend_group_id")
    ...
    @property
    @pulumi.getter(name="routeObservabilityToThisProject")
    def route_observability_to_this_project(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the project is route observability for this project. If dalse, the project will be route observability for all projects to the default project.
        """
        return pulumi.get(self, "route_observability_to_this_project")
