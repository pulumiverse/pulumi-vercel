...
class GetMicrofrontendGroupMembershipResult:
    ...
    def microfrontend_group_id(self) -> builtins.str:
        """
    ...
    def route_observability_to_this_project(self) -> builtins.bool:
        """
...
def get_microfrontend_group_membership(microfrontend_group_id: Optional[builtins.str] = None,
    ...
    example = vercel.get_microfrontend_group_membership(microfrontend_group_id="mfe_xxxxxxxxxxxxxxxxxxxxxxxxxxxx",
        project_id="prj_xxxxxxxxxxxxxxxxxxxxxxxxxxxx")
    ```


    :param builtins.str microfrontend_group_id: The ID of the microfrontend group.
    :param builtins.str project_id: The ID of the project.
    :param builtins.str team_id: The team ID to add the microfrontend group to. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
...
def get_microfrontend_group_membership_output(microfrontend_group_id: Optional[pulumi.Input[builtins.str]] = None,
                                              project_id: Optional[pulumi.Input[builtins.str]] = None,
                                              team_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMicrofrontendGroupMembershipResult]:
    """
    Provides information about an existing Microfrontend Group Membership.
