...
class GetMicrofrontendGroupMembershipResult:
    ...
    def microfrontend_group_id(self) -> _builtins.str:
        """
    ...
    def route_observability_to_this_project(self) -> _builtins.bool:
        """
...
def get_microfrontend_group_membership(microfrontend_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str microfrontend_group_id: The ID of the microfrontend group.
    :param _builtins.str project_id: The ID of the project.
    :param _builtins.str team_id: The team ID to add the microfrontend group to. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
...
def get_microfrontend_group_membership_output(microfrontend_group_id: Optional[pulumi.Input[_builtins.str]] = None,
