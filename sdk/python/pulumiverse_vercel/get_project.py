...
class GetProjectResult:
    ...
    def auto_assign_custom_domains(self) -> _builtins.bool:
        """
    ...
    def automatically_expose_system_environment_variables(self) -> _builtins.bool:
        """
    ...
    def build_machine_type(self) -> _builtins.str:
        """
    ...
    def customer_success_code_visibility(self) -> _builtins.bool:
        """
    ...
    def dev_command(self) -> _builtins.str:
        """
    ...
    def directory_listing(self) -> _builtins.bool:
        """
    ...
    def enable_affected_projects_deployments(self) -> _builtins.bool:
        """
    ...
    def enable_preview_feedback(self) -> _builtins.bool:
        """
    ...
    def enable_production_feedback(self) -> _builtins.bool:
        """
    ...
    def function_failover(self) -> _builtins.bool:
        """
    ...
    def git_fork_protection(self) -> _builtins.bool:
        """
    ...
    def git_lfs(self) -> _builtins.bool:
        """
    ...
    def ignore_command(self) -> _builtins.str:
        """
    ...
    def on_demand_concurrent_builds(self) -> _builtins.bool:
        """
    ...
    def output_directory(self) -> _builtins.str:
        """
    ...
    def preview_comments(self) -> _builtins.bool:
        """
    ...
    def preview_deployments_disabled(self) -> _builtins.bool:
        """
    ...
    def prioritise_production_builds(self) -> _builtins.bool:
        """
    ...
    @_utilities.deprecated("""This attribute is deprecated and no longer has any effect. The public source feature has been removed from Vercel and is no longer returned by the API. It will be removed in a future major version of this provider.""")
    def public_source(self) -> _builtins.bool:
        """
    ...
    def serverless_function_region(self) -> _builtins.str:
        """
    ...
    def skew_protection(self) -> _builtins.str:
        """
...
def get_project(build_machine_type: Optional[_builtins.str] = None,
                name: Optional[_builtins.str] = None,
                on_demand_concurrent_builds: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str build_machine_type: The build machine type to use for this project.
    :param _builtins.str name: The name of the project.
    :param _builtins.bool on_demand_concurrent_builds: Instantly scale build capacity to skip the queue, even if all build slots are in use. You can also choose a larger build machine; charges apply per minute if it exceeds your team's default.
    :param _builtins.str team_id: The team ID the project exists beneath. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
...
def get_project_output(build_machine_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       ...
                       on_demand_concurrent_builds: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
