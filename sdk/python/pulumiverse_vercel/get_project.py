...
class GetProjectResult:
    ...
    def auto_assign_custom_domains(self) -> builtins.bool:
        """
    ...
    def automatically_expose_system_environment_variables(self) -> builtins.bool:
        """
    ...
    def customer_success_code_visibility(self) -> builtins.bool:
        """
    ...
    def directory_listing(self) -> builtins.bool:
        """
    ...
    def enable_affected_projects_deployments(self) -> builtins.bool:
        """
    ...
    def enable_preview_feedback(self) -> builtins.bool:
        """
    ...
    def enable_production_feedback(self) -> builtins.bool:
        """
    ...
    def function_failover(self) -> builtins.bool:
        """
    ...
    def git_fork_protection(self) -> builtins.bool:
        """
    ...
    def git_lfs(self) -> builtins.bool:
        """
    ...
    def on_demand_concurrent_builds(self) -> builtins.bool:
        """
    ...
    def preview_comments(self) -> builtins.bool:
        """
    ...
    def prioritise_production_builds(self) -> builtins.bool:
        """
    ...
    def protection_bypass_for_automation(self) -> builtins.bool:
        """
    ...
    def public_source(self) -> builtins.bool:
        """
...
def get_project(name: Optional[builtins.str] = None,
                on_demand_concurrent_builds: Optional[builtins.bool] = None,
    ...
    :param builtins.bool on_demand_concurrent_builds: Instantly scale build capacity to skip the queue, even if all build slots are in use. You can also choose a larger build machine; charges apply per minute if it exceeds your team's default.
    :param builtins.str team_id: The team ID the project exists beneath. Required when configuring a team resource if a default team has not been set in the provider.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_project_output(name: Optional[pulumi.Input[builtins.str]] = None,
                       on_demand_concurrent_builds: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
