...
class GetTeamMemberResult:
    ...
    def access_groups(self) -> Sequence[builtins.str]:
        """
...
def get_team_member(team_id: Optional[builtins.str] = None,
    ...
    :param builtins.str team_id: The ID of the existing Vercel Team.
    :param builtins.str user_id: The ID of the existing Vercel Team Member.
    """
    __args__ = dict()
...
def get_team_member_output(team_id: Optional[pulumi.Input[builtins.str]] = None,
