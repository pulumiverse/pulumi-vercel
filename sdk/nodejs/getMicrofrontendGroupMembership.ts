 ...
 * ```
 */
export function getMicrofrontendGroupMembershipOutput(args: GetMicrofrontendGroupMembershipOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMicrofrontendGroupMembershipResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
