...
export class ProjectDeploymentRetention extends pulumi.CustomResource {
     ...
     */
    declare public readonly expirationCanceled: pulumi.Output<string>;
    /**
     * The retention period for errored deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
     */
    declare public readonly expirationErrored: pulumi.Output<string>;
    /**
     * The retention period for preview deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
     */
    declare public readonly expirationPreview: pulumi.Output<string>;
    /**
     * The retention period for production deployments. Should be one of '1d', '1w', '1m', '2m', '3m', '6m', '1y'.
     */
    declare public readonly expirationProduction: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ProjectDeploymentRetentionArgs | ProjectDeploymentRetentionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["expirationCanceled"] = state?.expirationCanceled;
            resourceInputs["expirationErrored"] = state?.expirationErrored;
            resourceInputs["expirationPreview"] = state?.expirationPreview;
            resourceInputs["expirationProduction"] = state?.expirationProduction;
            ...
            resourceInputs["expirationCanceled"] = args?.expirationCanceled;
            resourceInputs["expirationErrored"] = args?.expirationErrored;
            resourceInputs["expirationPreview"] = args?.expirationPreview;
            resourceInputs["expirationProduction"] = args?.expirationProduction;
