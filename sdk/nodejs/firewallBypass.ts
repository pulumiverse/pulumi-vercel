 ...
 * const bypassTargeted = new vercel.FirewallBypass("bypassTargeted", {
 *     projectId: example.id,
 *     sourceIp: "5.6.7.8",
 *     domain: "my-production-domain.com",
 * });
 * const bypassCidr = new vercel.FirewallBypass("bypassCidr", {
 *     projectId: example.id,
 *     sourceIp: "52.33.44.0/24",
 *     domain: "my-production-domain.com",
 * });
 * const bypassAll = new vercel.FirewallBypass("bypassAll", {
 *     projectId: example.id,
 *     sourceIp: "52.33.44.0/24",
 *     domain: "*",
 * });
