...
namespace Pulumiverse.Vercel.Outputs
{
    ...
    [OutputType]
    public sealed class GetProjectGitProviderOptionsConsolidatedGitCommitStatusResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetProjectGitProviderOptionsConsolidatedGitCommitStatusResult(
            bool enabled,
